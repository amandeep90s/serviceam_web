        ...
        $.ajax({
            ...
            success: (response, textStatus, jqXHR) => {
                ...
                if(isSocket != null && Object.keys(data.responseData.data).length == 0) {
                    ...
                    alertMessage(textStatus, "No Drivers Found", "danger");
                        ...
                        <div className="col-md-12 col-sm-12 col-lg-12 p-0 dis-row">
                            ...
                            <div className="col-md-6 col-sm-6 col-lg-6">
                                <dl className="dl-horizontal left-right mt-1">
                                    ...
                                    <dt>Time</dt>
                                    <dd>
                                        {new Date( this.props.request.assigned_time ).toLocaleDateString("en-Us")}{" "} {new Date( this.props.request.assigned_time ).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" })}
                                    </dd>
                                </dl>
                                <div>
                                    <img style={{ boxShadow: "2px 2px 10px #ccc" }} src={ "https://maps.googleapis.com/maps/api/staticmap?autoscale=1&size=620x380&maptype=terrian&format=png&visual_refresh=true&markers=icon:"+window.url+"/assets/layout/images/common/marker-start.png%7C"+this.props.request.s_latitude+","+this.props.request.s_longitude+"&key=" + getSiteSettings().site.browser_key } />
                        ...
                        <div className="col-md-12 col-sm-12 col-lg-12 p-0 dis-row">
                            ...
                            <div className="col-md-6 col-sm-6 col-lg-6">
                                <dl className="dl-horizontal left-right mt-1">
                                    ...
                                    <dt>Time</dt>
                                    <dd>
                                        {new Date( this.props.request.assigned_time ).toLocaleDateString("en-Us")}
                                        {new Date(this.props.request.assigned_time).toLocaleTimeString([], {hour: "2-digit", minute: "2-digit" })}
                                    </dd>
                                </dl>
                                <div>
                        ...
                        <dl className="dl-horizontal left-right mt-5">
                            ...
                            {this.props.request.payment.payable ? (
                                <span>
                                    ...
                                    <dd>
                                        <h6>
                                            {this.props.request.currency}{this.props.request.payment.payable}
