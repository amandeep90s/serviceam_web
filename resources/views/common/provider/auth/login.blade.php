                    ...
                    <div class="dis-center">
                        ...
                        <div id="login" class="h-100 col-sm-12 col-md-12 col-lg-12 col-xl-12 dis-column  ">
                            <form class="col-sm-12 col-md-12 col-lg-12 validateForm">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-12 p-0 dis-column">
                                    ...
                                    <span><strong><a href="{{ url('/provider/signup') }}"
                                                class="signup-link">{{ __('auth.signup') }}</a></strong></span>
                                    </h6>

                                    <div class="col-sm-12 p-0">
                                        <input id="email" name="email" class="form-control required email mb-4"
                                            style="" placeholder="{{ __('auth.email_address') }}" type="email"
                                            aria-required="true">
                                    </div>
                                    <div class="col-sm-12 p-0">
                                    ...
                                    <button type="submit" class="btn btn-primary mb-4 login">{{ __('auth.login') }}<i
                            ...
                            <span><strong><a href="{{ url('/provider/forgot-password') }}"
                                        class="signup-link">{{ __('auth.forgot_password') }}</a></strong></span>
                        ...
                        <div id="social-login"
                            ...
                            <form class="col-sm-12 col-md-12 col-lg-12">
                                ...
                                <a class="btn btn-block btn-green btn-md mb-4 social_login">{{ __('auth.submit') }}<i
