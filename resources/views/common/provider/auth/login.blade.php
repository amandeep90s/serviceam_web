                    ...
                    <div class="dis-center">
                        ...
                        <div id="login" class="h-100 col-sm-12 col-md-12 col-lg-12 col-xl-12 dis-column  ">
                            ...
                            <form class="col-sm-12 col-md-12 col-lg-12 validateForm">
                              ...
                              <span class="radio-box"><input type="radio" checked="checked" name="filter" value="email" id="filt1-5"><label for="filt1-5">@lang('auth.email')</label></span>
                           </div> --}}
                                  ...
                                  <input type="text" id="phone" class="intl-tel phone form-control mb-4" placeholder="Phone Number" >
                                    ...
                                    <button type="submit" class="btn btn-primary mb-4 login">@lang('auth.login')<i
                        ...
                        <div id="social-login"
                            ...
                            <form class="col-sm-12 col-md-12 col-lg-12">
                                ...
                                <a class="btn btn-block btn-green btn-md mb-4 social_login">@lang('auth.submit')<i
