    ...
    <section class="z-1 content-box" id="profile-form">
        <div class="profile-section">
            ...
            <div class="clearfix tab-content">
                                            ...
                                            <div class="photo-section">
                                                ...
                                                <div class="fileUpload up-btn profile-up-btn">
                                                    <input type="file" id="profile_img_upload_btn" name="picture"
                                                        class="upload" accept="image/x-png, image/jpeg">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="profile-content">
                            @if (Helper::getDemomode() == 1)
                                <div class="alert alert-danger">
                                    "CRUD Feature" has been disabled on the Demo Admin Panel. This feature will be enabled
                                    on your product which you will be purchasing, meahwhile if you have any queries feel
                                    free to contact our 24/7 support at info@uberlikeapp.com.
                                </div>
                            @endif
                            <div class="row m-0">
                ...
                <!--Password end !-->
                <!--Add card details !-->
                <div role="tabpanel" class="tab-pane col-sm-12 col-md-12 col-lg-12 p-0  min-46vh payment_method"
                    id="payment_method">
                    <div class="col-lg-12 col-md-12 col-sm-12 p-0 dis-column payment border-bottom pb-3">
                        ...
                        @if ($card == 1)
                            <div class=" col-lg-12 col-md-12 col-sm-12 p-0 dis-ver-center flex-wrap mt-3">
                                <div id="card_container" class="col-lg-4 col-md-12 col-sm-12 c-pointer p-0 dis-center"
                                    data-toggle="modal" data-target="#add_card">
                                    <div class="add-card">
                                        <div class="add-img">
                                                        ...
                                                        <div class="col-sm-12 p-0 card-form">
                                                            ...
                                                            <div class="col-sm-12 dis-row p-0">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <input class="form-control numbers" type="text"
                                                                        maxlength="2" required autocomplete="off"
                                                                        data-stripe="exp-year" class="form-control"
                                                                        placeholder="YY">
                                                                </div>
                ...
                <!-- Provider Timings Start -->

                <div role="tabpanel" class="tab-pane col-sm-12 col-md-12 col-lg-12 p-0 timings" id="provider_timings">
                    <div class="col-md-12">
                        <div class="profile-content">
                            <div class="row m-0">
                                <form class="w-100 timingForm" style= "color:red;">
                                    <!-- Sunday -->
                                    <div class="col-md-12 col-sm-12 pro-form dis-ver-center p-0">
                                        ...
                                        <div class="col-md-3 col-sm-12">
                                            ...
                                            <input class="form-control clockpicker" id ="sun_st_time" name="sun_st_time"
                                                placeholder="Start Time">
                                        </div>

                                        <div class="col-md-3 col-sm-12">

                                            <input class="form-control clockpicker" id ="sun_ed_time" name="sun_ed_time"
                                    ...
                                    <div class="col-md-12 col-sm-12 pro-form dis-ver-center p-0">
                                        ...
                                        <div class="col-md-3 col-sm-12">
                                            ...
                                            <input class="form-control clockpicker" id ="mon_st_time" name="mon_st_time"
                                                placeholder="Start Time">
                                        </div>

                                        <div class="col-md-3 col-sm-12">

                                            <input class="form-control clockpicker" id ="mon_ed_time" name="mon_ed_time"
                                                placeholder="End Time">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 pro-form dis-ver-center p-0">
                                        ...
                                        <div class="col-md-3 col-sm-12">
                                            ...
                                            <input class="form-control clockpicker" id ="tues_st_time"
                                                name="tues_st_time" placeholder="Start Time">
                                        </div>

                                        <div class="col-md-3 col-sm-12">

                                            <input class="form-control clockpicker" id ="tues_ed_time"
                                                name="tues_ed_time" placeholder="End Time">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 pro-form dis-ver-center p-0">
                                        ...
                                        <div class="col-md-3 col-sm-12">
                                            ...
                                            <input class="form-control clockpicker" id ="wed_st_time" name="wed_st_time"
                                                placeholder="Start Time">
                                        </div>

                                        <div class="col-md-3 col-sm-12">

                                            <input class="form-control clockpicker" id ="wed_ed_time" name="wed_ed_time"
                                                placeholder="End Time">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 pro-form dis-ver-center p-0">
                                        ...
                                        <div class="col-md-3 col-sm-12">
                                            ...
                                            <input class="form-control clockpicker" id ="thurs_st_time"
                                                name="thurs_st_time" placeholder="Start Time">
                                        </div>

                                        <div class="col-md-3 col-sm-12">

                                            <input class="form-control clockpicker" id ="thurs_ed_time"
                                                name="thurs_ed_time" placeholder="End Time">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 pro-form dis-ver-center p-0">
                                        ...
                                        <div class="col-md-3 col-sm-12">
                                            ...
                                            <input class="form-control clockpicker" id ="fri_st_time" name="fri_st_time"
                                                placeholder="Start Time">
                                        </div>

                                        <div class="col-md-3 col-sm-12">

                                            <input class="form-control clockpicker" id ="fri_ed_time" name="fri_ed_time"
                                                placeholder="End Time">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 pro-form dis-ver-center p-0">
                                        ...
                                        <div class="col-md-3 col-sm-12">
                                            ...
                                            <input class="form-control clockpicker" id ="sat_st_time" name="sat_st_time"
                                                placeholder="Start Time">
                                        </div>

                                        <div class="col-md-3 col-sm-12">

                                            <input class="form-control clockpicker" id ="sat_ed_time" name="sat_ed_time"
                                                placeholder="End Time">
                                        </div>
                                    </div>
...
@section('scripts')
    ...
    <script>
            ...
            if (phoneNumber != "") {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        alertMessage("Success", "OTP Sent !!", "success");
                    },
        ...
        $(document).ready(function() {
                ...
                success: (data, textStatus, jqXHR) => {
                    ...
                    if (bankform.length != 0) {
                        ...
                        for (var i in bankform) {
                            html += `<div class="col-md-4 "><h5 class=""><strong>` + bankform[i].label +
                                `</strong></h5>`;
                            var type = 'number';
                            ...
                            html += `<input type="hidden" name ="bankform_id[` + i + `]" value ="` +
                                bankform[i].id + `">
                        <input type="` + type + `" class="form-control" name="keyvalue[` + i + `]" value ="` +
                                inputvalue + `" placeholder="` + bankform[i].label + `" >
                        <input type="hidden" class="editid" name ="id[` + i + `]" value ="` + editid + `"> </div>`;
                        }
                        html +=
                            `</div><button type="submit" id="submit-button"  class="btn btn-primary mt-3">Save</button><br>`;
                        $('.bankForm').html(html);
                    }
                },
                error: (jqXHR, textStatus, errorThrown) => {
            ...
            $('.timingForm').validate({
                ...
                submitHandler: function(form, e) {
                    var data = new FormData();
                    var formGroup = $(".timingForm").serialize().split("&");
                    for (var i in formGroup) {
                        var params = formGroup[i].split("=");
                        data.append(decodeURIComponent(params[0]), decodeURIComponent(params[1]));
                    }

                    var url = getBaseUrl() + "/provider/timings";

                    updateTimings(data, url)
                }
            });

            function updateTimings(data, url) {
                $.ajax({
                    url: url,
                    type: "post",
                    data: data,
                    ...
                    success: function(response, textStatus, jqXHR) {
                        ...
                        alertMessage("Success", data.message, "success");
                        setTimeout(function() {
                            window.location.replace('/provider/profile/provider_timings');
                        }, 1000);
                    },
                    error: function(jqXHR, textStatus, errorThrown) {
                        alertMessage(textStatus, jqXHR.responseJSON.message, "danger");
                    ...
                    $.each(result, function(key, item) {
                        html += `<div class="col-lg-4 col-md-12 col-sm-12 card-section">
                              ...
                              <div class="card-img">
                                 ...
                                 <span>XXXX</span> <span>XXXX</span><span>XXXX</span><span class ="last_four">` + item
                            .last_four + `</span><br>
                                    <small></small><br>`;
                        if (item.holder_name) {
                            html += `<span class = "holder_name">` + item.holder_name +
                                `</span>`;
                        }
                        html +=
                            `</div>
                              ...
                              <div class="col-sm-12 p-0 card-form dis-center">
                                 <button  class="btn btn-danger change-pswrd mt-1 delete" data-toggle="modal" data-target="#edit_account" data-id ="` +
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('.account_balance_wallet').text((result.currency_symbol) + ' ' + (result
            ...
            //List Provider Timing Details
            $.ajax({
                type: "GET",
                url: getBaseUrl() + "/provider/timings",
                headers: {
                    Authorization: "Bearer " + getToken("provider")
                },
                success: function(data) {
                    ...
                    $('#sun_st_time').val(result.sun_st_time);
                    $('#sun_ed_time').val(result.sun_ed_time);
                    $('#mon_st_time').val(result.mon_st_time);
                    $('#mon_ed_time').val(result.mon_ed_time);
                    $('#tues_st_time').val(result.tues_st_time);
                    $('#tues_ed_time').val(result.tues_ed_time);
                    $('#wed_st_time').val(result.wed_st_time);
                    $('#wed_ed_time').val(result.wed_ed_time);
                    $('#thurs_st_time').val(result.thurs_st_time);
                    $('#thurs_ed_time').val(result.thurs_ed_time);
                    $('#fri_st_time').val(result.fri_st_time);
                    $('#fri_ed_time').val(result.fri_ed_time);
                    $('#sat_st_time').val(result.sat_st_time);
                    $('#sat_ed_time').val(result.sat_ed_time);
    ...
    <script
        src = "https://maps.googleapis.com/maps/api/js?key={{ Helper::getSettings()->site->browser_key }}&libraries=places&callback=initMap"
        async defer>
        < /script>
    @stop
