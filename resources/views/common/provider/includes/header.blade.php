<header class="topnav" id="myTopnav">
    <div class="col-lg-12 col-md-12 col-sm-12 dis-space-btw">
        <div id="mySidenav" class="sidenav">
            ...
            <a href="./provider-dashboard.html">Home</a>
            <a href="./provider-transaction.html">Account</a>
            <a href="./provider-transaction-histrory.html">Histroy</a>
        </div>
        <div id="mySidenav" class=" dis-ver-center col-md-7 col-sm-6 p-0">
            ...
            <a href="{{ url('/provider/home') }}" class="logo"><img src="{{ Helper::getSiteLogo() }}" class=""
                    alt="logo"></a>
        </div>

        <div class="col-md-3 col-sm-4 col-xl-1 dis-end d-none  mt-2 d-sm-none d-md-none d-xl-block  online">
            <p class="p-0 go-online">Go Online</p>
            <span class="p-0 go-offline d-none">Go Offline</span>
            <label class="toggleSwitch nolabel" onclick="">
                <input id="service_status" type="checkbox" checked />
                <span>
                    <span class="show1">OFF</span>
                    <span class="show2">ON</span>
                </span>
                <a></a>
            </label>
        </div>
                ...
                <li class="col-xl-4 col-md-6 col-sm-12 p-0">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{ url('provider/profile/general') }}"><i
                                class="material-icons">account_box</i> Profile </a>
                        <a class="dropdown-item" href="{{ url('provider/trips/service') }}"> <i
                                class="material-icons">history</i> History </a>
                        <!-- <a class="dropdown-item" href="{{ url('provider/wallet') }}"><i
         class="material-icons">account_balance_wallet</i> Wallet</a> -->
                        <a class="dropdown-item c-pointer referdetail" data-toggle="modal" data-target="#referModal"><i
                                class="material-icons ">card_giftcard</i> Referrrals</a>
                        <a class="dropdown-item c-pointer notification" data-toggle="modal"
                            data-target="#notification"><i class="material-icons ">card_giftcard</i> Notification</a>
                        <a class="dropdown-item" href="{{ url('provider/logout') }}">
                            <i class="material-icons">reply</i> Logout</a>
                    </div>
                </li>
            </ul>
        </div>
