                    ...
                    @if ($card == 1)
                        <div class="col-md-4 col-lg-4 col-sm-12 p-0">
                            <form class="validateCardForm" style= "color:red;">
                                ...
                                <input type="text" id ="amount" class="form-control price" name="amount"
                                ...
                                <button id="submit-button"
                                    class="btn btn-secondary mt-3">{{ __('user.add_money') }}</button>
                            </form>
                        </div>
                    @endif
                </div>
...
@section('scripts')
    ...
    <script>
        ...
        $('.validateCardForm').validate({
            ...
            messages: {
                card_id: {
                    required: "{{ __('user.card_required') }}",
                    maxLength: 'test'
                },
                amount: {
                    required: "{{ __('user.amount_required') }}"
                },
            },
