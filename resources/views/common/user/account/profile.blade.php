...
@section('content')
    ...
    <section class="z-1 content-box" id="profile-form">
        <div class="profile-section">
            ...
            <div class="clearfix tab-content">
                                ...
                                <form class="w-100 validateForm" style= "color:red;">
                                    ...
                                    <div class="col-md-12 pro-form dis-ver-center p-0">
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            ...
                                            <span>
                                                <i class="fa fa-edit  user_edit"
                                                    style=" position: absolute; right: 10%; top: 61%;color: #495057;font-size: 18px;cursor: pointer;"></i>
                                            </span>
                                            <span>
                                                <i class="fa fa-check user_update"
                ...
                @if ($card == 1)
                    <div role="tabpanel" class="tab-pane col-sm-12 col-md-12 col-lg-12 p-0  min-46vh"
                        id="payment_method">
                        <div class="col-lg-12 col-md-12 col-sm-12 p-0 dis-column payment">
                            ...
                            <div class=" col-lg-12 col-md-12 col-sm-12 p-0 dis-ver-center flex-wrap">
                                ...
                                <!-- Card details!-->
                                <div id="card_container" class=" dis-column  ml-3 mr-3" data-toggle="modal"
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 card-section p-0 b-0"
                                                ...
                                                <div class="col-sm-12 col-xl-6">
                                                    <span class="fa fa-location-arrow"
                                                        style=" position: absolute; left: 20px; top: 25px;color: #495057;font-size: 18px;"></span>
                                                    <input class="form-control search-loc-form" type="text"
                                                        id="pac-input" name="map_address"
                                                        placeholder="Search for area, street name.." required>
                                                    <input type="hidden" id="latitude" name="latitude"
                                                        value="{{ old('latitude') }}" readonly>
                                                    <input type="hidden" id="longitude" name="longitude"
                                                        value="{{ old('longitude') }}" readonly>
                                                    <div id="my_map" style="height:500px;width:100%;"></div>
                                                    <span class="my_map_form_current"><i
                                                            class="material-icons my_map_form_current"
                                                            style=" position: absolute; right: 30px; top: 25px;color: #495057;font-size: 18px;cursor: pointer;">my_location</i>
                                                    </span>
                                                </div>
    ...
    <div class="modal fade bs-modal-lg confirm-modal" tabindex="-1" role="basic" aria-hidden="true"
...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
                    ...
                    success: function(data) {
                     ...
                     <div class="card-img">
                        ...
                        <div class="card-number">
                           ...
                           <span class = "holder_name">` + item.holder_name +
                                `</span>
                        </div>
                     </div>
                     <div class="col-sm-12 p-0 card-form dis-center">
                        <button  class="btn btn-secondary change-pswrd mt-1 delete" data-toggle="modal" data-target="#edit_card" data-id ="` +
                                item.id + `">{{ __('user.delete') }}</button>
                     </div>
                  </div>`;
                        });
            ...
            $(document).on('click', '.addressedit', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#address_type option[value='" + result.address_type + "']").prop(
                            'selected', true);
            ...
            $('.validatepasswordForm').validate({
                ...
                messages: {
                    old_password: {
                        required: "{{ __('user.old_password_required') }}"
                    },
                    password: {
                        required: "{{ __('user.password_required') }}"
                    },
                    password_confirmation: {
                        required: "{{ __('user.password_confirmation_required') }}",
                        equalTo: "{{ __('user.password_confirmation_equalto') }}"
                    },
                },
                highlight: function(element) {
                    $(element).closest('.form-group').addClass('has-error');
            ...
            $('.validateaddressForm').validate({
                ...
                messages: {
                    map_address: {
                        required: "{{ __('user.map_address_required') }}"
                    },
                    latitude: {
                        required: "{{ __('user.latitude_required') }}"
                    },
                    longitude: {
                        required: "{{ __('user.latitude_required') }}"
                    },
                    address_type: {
                        required: "{{ __('user.address_type_required') }}"
                    },
                    flat_no: {
                        required: "{{ __('user.flat_no_required') }}"
                    },
                    street: {
                        required: "{{ __('user.street_required') }}"
                    }
                },
                highlight: function(element) {
                    $(element).closest('.form-group').addClass('has-error');
    ...
    <script>
        ...
        $('.my_map_form_current').on('click', function() {
            ...
            var current_latitude = 37.0902;
            var current_longitude = 95.7129;
