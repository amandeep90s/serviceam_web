                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="name" name="name"
                            placeholder="{{ __('admin.roles.role_name') }}" value="" autocomplete="off"
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <label for="notify_status"
                            class="col-xs-2 col-form-label">{{ __('admin.roles.role_permissions') }}</label>
...
<script>
    ...
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data, textStatus, jqXHR) {
                    ...
                    $.each(group_data, function(i, dataval) {
                        ...
                        conthtml +=
                            '<fieldset class="scheduler-border"><legend class="scheduler-border"><h6 class="m-0"><span ><input class="checkper" type="checkbox" id="chk_' +
                            str_name + '"></span>' + i + '</h6></legend>';
                        ...
                        $.each(dataval, function(k, data) {
                            ...
                            conthtml += '<span class="clkbox" data-id="nk_' +
                                str_name +
                                '"=""><label style="margin-right: 20px; margin-bottom: 20px;"><input type="checkbox" value="' +
                                data.id +
                                '" name="permission[]" id="permission" class="permission_' +
                                str_name +
                                '" ' + checked + '>' + data.display_name +
                                '</label></span>';
                        });
        ...
        $('.validateForm').validate({
            ...
            messages: {
                name: {
                    required: "{{ __('admin.roles.role_name') }} is required."
                },
                'permission[]': {
                    required: "{{ __('admin.roles.role_permissions') }} is required."
                },
