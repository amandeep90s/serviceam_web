      ...
      <div class="col-md-12">
        <div class="card card-small">
          ...
          <table id="data-table" class="table table-hover table_width display">
            <thead>
              <tr>
                <th data-value="id">@lang('admin.roles.column1')</th>
                <th data-value="name">@lang('admin.roles.column2')</th>
          ...
          },
          {
            ...
            render: function(data, type, row) {
              if ({{ Helper::getDemomode() }} != 1) {
                ...
                var button =
                  '<div class="input-group-btn action_group"> <li class="action_icon"> <button type="button"class="btn btn-info btn-block "data-toggle="dropdown"><i class="fa fa-ellipsis-v" aria-hidden="true" title="View"></i></button><ul class="dropdown-menu"><li><a href="javascript:;" data-id="' +
                  data +
                  '" class="dropdown-item edit"><i class="fa fa-edit"></i> Edit</a> </li><li><a href="javascript:;" data-id="' +
                  data +
                  '" class="dropdown-item delete"><i class="fa fa-trash"></i>&nbsp;Delete</a> </li></ul> </li></div>';
                return button;
              } else {
