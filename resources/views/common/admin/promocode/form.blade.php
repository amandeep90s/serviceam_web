<div class="row mb-4">
    <div class="col-md-12">
        <div class="card-header border-bottom">
            ...
            @endif
            <h6 class="m-0"style="margin:10!important;"> {{ $action_text }} Promocode</h6>
        </div>
        <div class="form_pad">
            <form class="validateForm">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="promo_code"
                            class="col-xs-2 col-form-label">{{ __('admin.promocode.promocode') }}</label>
                        <div class="col-xs-10">
                            <input class="form-control" autocomplete="off" type="text"
                                value="{{ old('promo_code') }}" name="promo_code" required id="promo_code"
                                placeholder="Promocode">
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="percentage"
                            class="col-xs-2 col-form-label">{{ __('admin.promocode.percentage') }}</label>
                        <div class="col-xs-10">
                            <input class="form-control numbers" type="text" value="{{ old('percentage') }}"
                                name="percentage" required id="percentage" placeholder="Percentage" autocomplete="off">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="max_amount"
                            class="col-xs-2 col-form-label">{{ __('admin.promocode.max_amount') }}</label>
                        <div class="col-xs-10">
                            <input type="text" class="form-control numbers" name="max_amount" required
                                id="max_amount" placeholder="Max Amount" value="{{ old('max_amount') }}"
                                autocomplete="off"">
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="expiration"
                            class="col-xs-2 col-form-label">{{ __('admin.promocode.expiration') }}</label>
                        <div class="col-xs-10">
                            <input class="form-control datetimepicker" type="text" value="{{ old('expiration') }}"
                                name="expiration" autocomplete="off" required id="expiration" placeholder="Expiration">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="promo_description"
                            class="col-xs-2 col-form-label">{{ __('admin.promocode.promo_description') }}</label>
                        <div class="col-xs-10">
                ...
                <button type="submit" class="btn btn-accent">{{ $action_text }} Promocode</button>
