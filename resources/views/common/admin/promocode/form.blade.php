      ...
      <form class="validateForm">
          ...
          <div class="form-group col-md-6">
            ...
            <div class="col-xs-10">
              <input class="form-control" autocomplete="off" type="text" value="{{ old('promo_code') }}"
                name="promo_code" required id="promo_code" placeholder="Promocode">
            </div>
          </div>
          <div class="form-group col-md-6">
            <label for="percentage" class="col-xs-2 col-form-label">@lang('admin.promocode.percentage')</label>
            <div class="col-xs-10">
              <input class="form-control numbers" type="text" value="{{ old('percentage') }}" name="percentage"
                required id="percentage" placeholder="Percentage" autocomplete="off">
            </div>
          </div>
        </div>
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <div class="col-xs-10">
              <input type="text" class="form-control numbers" name="max_amount" required id="max_amount"
                placeholder="Max Amount" value="{{ old('max_amount') }}" autocomplete="off"">
            </div>
          </div>
          <div class="form-group col-md-6">
