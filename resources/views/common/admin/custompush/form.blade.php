<div class="row mb-4">
    <div class="col-md-12">
        <div class="card-header border-bottom">
            ...
            @endif
            <h6 class="m-0"style="margin:10!important;">{{ $action_text }} Custom Push</h6>
        </div>
        <div class="form_pad">
            <form class="validateForm" method="POST" role="form" id="create_push">
                ...
                <div class="form-row">
                    <div class="form-group row" id="for_users" style="display: none;">
                        <label class="form-group col-md-12 col-form-label">User Conditions</label>
                        <div class="form-group col-md-6">
                            <select class="form-control" name="user_condition"
                                onchange="switch_user_condition(this.value);">
                        ...
                        <div class="form-group col-md-4" id="user_location" style="display: none;">
                            <input type="text" class="form-control" name="user_location" id="search_location"
                ...
                <div class="form-row">
                    <div class="form-group row" id="for_providers" style="display: none;">
                        <label class="form-group col-md-12 col-form-label">Driver Conditions</label>
                        <div class="col-md-6">
                            <select class="form-control" name="provider_condition"
                                onchange="switch_provider_condition(this.value);">
                                <option value="">NONE</option>
                                <option value="ACTIVE">who were active for </option>
                                <option value="LOCATION"> who are in </option>
                        ...
                        <div class="form-group col-md-4" id="provider_rides" style="display: none;">
                            <input type="number" class="form-control" name="provider_rides"
                                placeholder="Number of Rides">
                        </div>

                        <div class="form-group col-md-4" id="provider_amount" style="display: none;">
                            <input type="number" class="form-control" name="provider_amount"
                                placeholder="Amount Spent">
                        </div>

                        <div class="form-group col-md-4" id="provider_location" style="display: none;">
                            <input type="text" class="form-control" name="provider_location"
                                id="search_provider_location" placeholder="Enter Location">
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-xs-10">
                            <textarea maxlength="200" class="form-control" rows="3" name="message" required id="message"
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-xs-12">
                            ...
                            <button type="submit" class="btn btn-primary">{{ $action_text }}
                                {{ __('admin.push.Push_Now') }}</button>
                            &nbsp;
                            <button data-toggle="modal" data-target="#schedule_modal" type="button"
                                class="btn btn-success">{{ __('admin.push.Schedule_Push') }}</button>
                        ...
                        <div class="modal-content">
                            ...
                            <form>
                                <div class="modal-body">
                                    ...
                                    <label>Date</label>
                                    <input value="" class="form-control" type="text" id="datepicker"
                                        placeholder="Date" name="schedule_date">
                                    <label>Time</label>
                                    <input value="" class="form-control" type="text" id="timepicker"
                                        placeholder="Time" name="schedule_time">

                                </div>
                                <div class="modal-footer">
                                    <button type="reset" class="btn btn-danger schedule_close">Cancel</button>
                                    <button type="button" id="schedule_button" class="btn btn-default">Schedule
                                        Push</button>
                                </div>
                            </form>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if ($("input[name=id]").length) {
                ...
                var url = "{{ config('app.base_url') }}/admin/custompush" + id;
                setData(url);
            }
            $('.validateForm').validate({
                ...
                messages: {
                    user_condition: {
                        required: "User Condition is required."
                    },
                    provider_condition: {
                        required: "Provider Condition is required."
                    },
                    content: {
