<div class="row mb-4">
  <div class="col-md-12">
    <div class="card-header border-bottom">
      ...
      @endif
      <h6 class="m-0"style="margin:10!important;">{{ $action_text }} Reasons</h6>
    </div>
    <div class="form_pad">
      <form class="validateForm">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="reason" name="reason" placeholder="Reason" value=""
              autocomplete="off">
          </div>
          <div class="form-group col-md-6">
        ...
        <button type="submit" class="btn btn-accent">{{ $action_text }} Reason</button>
