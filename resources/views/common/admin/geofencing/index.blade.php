    ...
    <div class="main-content-container container-fluid px-4">
        <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                <span class="text-uppercase page-subtitle">Geofence</span>
                <h3 class="page-title">Geofence List</h3>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card card-small">
                    <div class="card-header border-bottom">
                        <h6 class="m-0 pull-left">Geofence</h6>

                        <a href="{{ url('admin/geo-fencing/create') }}" class="btn btn-success pull-right add"><i
                                class="fa fa-plus"></i> Add New Geofence</a>
                    ...
                    <table id="data-table" class="table table-hover table_width display">
                        <thead>
                            <tr>
                                ...
                                <th data-value="country_id">@lang('admin.geo_fencing.location')</th>
                                <th data-value="currency">@lang('admin.city.city')</th>
                    ...
                    },
                    {
                        "data": function(data, type, row) {
                            ...
                            var button =
                                ...
                                status + '</i></a></li>';
                            button += '<li><a href="{{ url('admin/geo-fencing') }}/' + data.id +
                                '/edit" class="dropdown-item edit"><i class="fa fa-edit"></i> Edit</a> </li>';
            ...
            $('body').on('click', '.status', function() {
                ...
                $(".status-modal-btn")
                    ...
                    .on("click", function() {
                        ...
                        var url = getBaseUrl() + "/admin/geofence/" + id + '/updateStatus?status=' +
                            value;
