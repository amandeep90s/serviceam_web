        ...
        <div class="stepwizard">
          <div class="stepwizard-row setup-panel">
            <div class="stepwizard-step">
              <a href="#general" type="button" class="btn btn-success tabs btn-circle">General</a>

            </div>
            <div class="stepwizard-step">
              <a href="#company-profile" type="button" class="btn btn-default tabs btn-circle" disabled="disabled">Comp.
                Profile Links</a>

            </div>
            <div class="stepwizard-step">
              <a href="#social-link" type="button" class="btn btn-default tabs btn-circle" disabled="disabled">Social
                Link Config</a>

            </div>

            <div class="stepwizard-step">
              <a href="#map-sms" type="button" class="btn btn-default tabs btn-circle" disabled="disabled">Map & SMS
                Config</a>

            </div>
            <div class="stepwizard-step">
              <a href="#mail" type="button" class="btn btn-default tabs btn-circle" disabled="disabled">Mail Config</a>

            </div>
            <div class="stepwizard-step">
              <a href="#push" type="button" class="btn btn-default tabs btn-circle" disabled="disabled">Push
                Notification</a>

            </div>
            <div class="stepwizard-step">
              <a href="#payment-setting" type="button" class="btn btn-default tabs btn-circle"
                disabled="disabled">Payment Settings</a>
            ...
            @if (Helper::checkService('SERVICE'))
              <div class="stepwizard-step">
                <a href="#service" type="button" class="btn btn-default tabs btn-circle" disabled="disabled">Service</a>
              </div>
            @endif
            ...
            <div class="stepwizard-step">
              <a href="#others" type="button" class="btn btn-default tabs btn-circle" disabled="disabled">Others</a>
              ...
              <div class="col-md-12">
                ...
                <div class="form-row">
                  ...
                  <div class="col-xl-12">
                    ...
                    <input class="form-control" type="text" value="{{ Helper::getSettings()->site->site_title }}"
                ...
                <div class="form-row">
                  <div class="col-xl-6">
                    ...
                    <input type="file" accept="image/*" name="site_icon" class="dropify form-control-file"
                      autocomplete="off" id="site_icon" aria-describedby="fileHelp">
                  </div>
                  <div class="col-xl-6">
                    ...
                    <input type="file" accept="image/*" name="site_logo" class="dropify form-control-file"
                      autocomplete="off" id="site_logo" aria-describedby="fileHelp">
                  </div>
                ...
                <div class="form-row">
                  <div class="col-xl-6">
                    ...
                    <input class="form-control phone" type="tel" minlength="6" name="contact_number" required
                  ...
                  <div class="col-xl-6">
                    ...
                    <input class="form-control" type="email" value="{{ Helper::getSettings()->site->contact_email }}"
                ...
                <div class="form-row">
                  <div class="col-xl-6">
                    ...
                    <input class="form-control phone" type="tel" minlength="1" maxlength="10" required
                      value="{{ Helper::getSettings()->site->sos_number }}" name="sos_number" id="sos_number"
                      placeholder="SOS Number">
                  </div>
                  <div class="col-xl-6">
                    <label for="tax_percentage" class=" col-form-label">@lang('admin.setting.Copyright_Content')</label>
                    <input class="form-control" type="text"
                      value="{{ Helper::getSettings()->site->site_copyright }}" name="site_copyright"
                      id="site_copyright" placeholder="Site Copyright">
                  </div>
                </div>
              ...
              <div class="col-md-12">
                ...
                <div class="form-row">
                  <div class="col-xl-6">
                    ...
                    <input class="form-control" type="text"
                      value="{{ Helper::getSettings()->site->store_link_android_user }}" name="store_link_android_user"
                      id="store_link_android_user" placeholder="@lang('admin.setting.Android_user_link')">
                  </div>
                ...
                <div class="form-row">
                  <div class="col-xl-6">
                    ...
                    <input class="form-control" type="text"
                      value="{{ Helper::getSettings()->site->store_link_ios_user }}" name="store_link_ios_user"
                      id="store_link_ios_user" placeholder="@lang('admin.setting.Ios_user_Link')">
                  </div>

                  <div class="col-xl-6">
                    <label for="store_link_ios_provider" class="col-xs-3 col-form-label">@lang('admin.setting.Ios_provider_Link')</label>
                    <input class="form-control" type="text"
                      value="{{ Helper::getSettings()->site->store_link_ios_provider }}" name="store_link_ios_provider"
                      id="store_link_ios_provider" placeholder="@lang('admin.setting.Ios_provider_Link')">
                  </div>
                </div>
                ...
                <div class="form-row">
                  <div class="col-xl-6">
                    ...
                    <input class="form-control" type="text"
                      value="{{ Helper::getSettings()->site->store_facebook_link }}" name="store_facebook_link"
                      id="store_facebook_link" placeholder="@lang('admin.setting.Facebook_Link')">
                  </div>

                  <div class="col-xl-6">
                    <label for="store_twitter_link" class="col-xs-3 col-form-label">@lang('admin.setting.Twitter_Link')</label>
                    <input class="form-control" type="text"
                      value="{{ Helper::getSettings()->site->store_twitter_link }}" name="store_twitter_link"
                      id="store_twitter_link" placeholder="@lang('admin.setting.Twitter_Link')">
                  </div>
                </div>
                @if (Helper::getDemomode() == 0)
              ...
              <div class="col-md-12">
                ...
                <div class="form-group">
                  ...
                  <div class="custom-control custom-toggle">
                    <input {{ Helper::getSettings()->site->social_login == '1' ? 'checked' : '' }} type="checkbox"
                      id="social_login" name="social_login" class="custom-control-input social_login" value ='1'>
                    <label class="custom-control-label " for="social_login"></label>
                  </div>
                </div>

                <div class="social_container hidesocial"
                  style=" {{ Helper::getSettings()->site->social_login == '0' ? 'display: none;' : '' }} ">
                  <hr>
                  <div class="form-group">
                    <label for="facebook_app_id" class="col-xs-3 col-form-label">@lang('admin.setting.facebook_app_id')</label>
                    <div class="col-xs-9">
                      <input class="form-control" type="text"
                        value="{{ Helper::getSettings()->site->facebook_app_id }}" name="facebook_app_id"
                        id="facebook_app_id" placeholder="@lang('admin.setting.facebook_app_id')">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xs-9">
                      <input class="form-control" type="text"
                        value="{{ Helper::getSettings()->site->facebook_app_secret }}" name="facebook_app_secret"
                        id="facebook_app_secret" placeholder="@lang('admin.setting.facebook_app_secret')">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xs-9">
                      <input class="form-control" type="text"
                        value="{{ Helper::getSettings()->site->google_client_id }}" name="google_client_id"
                        id="google_client_id" placeholder="@lang('admin.setting.google_client_id')">
                    </div>
                  </div>
            ...
            <div class="col-xs-12">
              ...
              <div class="col-md-12">
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control" type="text" value="{{ Helper::getSettings()->site->browser_key }}"
                      name="browser_key" required id="browser_key" placeholder="@lang('admin.setting.browser_key')">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control" type="text" value="{{ Helper::getSettings()->site->server_key }}"
                      name="server_key" required id="server_key" placeholder="@lang('admin.setting.server_key')">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control" type="text" value="{{ Helper::getSettings()->site->android_key }}"
                      name="android_key" required id="android_key" placeholder="@lang('admin.setting.android_key')">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control" type="text" value="{{ Helper::getSettings()->site->ios_key }}"
                      name="ios_key" required id="ios_key" placeholder="@lang('admin.setting.ios_key')">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control" type="text"
                      ...
                      name="facebook_app_version" required id="facebook_app_version" placeholder="@lang('admin.setting.fb_app_version')">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control" type="text"
                      ...
                      name="facebook_app_secret" required id="facebook_app_secret" placeholder="@lang('admin.setting.fb_app_secret')">
                  </div>
                </div>
                @if (Helper::getDemomode() == 0)
                  <button class="btn btn-success nextBtn btn-lg" type="submit">Submit</button>
            ...
            <div class="col-xs-12">
              <div class="col-md-12">
                <div class="form-group" id="mail_request">
                  ...
                  <br>
                  <div class="custom-control custom-toggle">
                    <input {{ Helper::getSettings()->site->send_email == '1' ? 'checked' : '' }} type="checkbox"
                      id="sendmailCheck" name="send_email" class="custom-control-input" value ='0'>
                ...
                <div class="form-group hidemail">
                  ...
                  <div class="col-xs-9">
                    <select class="form-control" name="mail_driver" required id="mail_driver">
                      <option value="SMTP" {{ Helper::getSettings()->site->mail_driver == 'SMTP' ? 'selected' : '' }}>
                        @lang('admin.setting.smtp')</option>
                      <option value="MAILGUN"
                        {{ Helper::getSettings()->site->mail_driver == 'MAILGUN' ? 'selected' : '' }}>@lang('admin.setting.mailgun')
                      </option>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group hidemail">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control" type="text" value="{{ Helper::getSettings()->site->mail_port }}"
                      name="mail_port" required id="mail_port" placeholder="@lang('admin.setting.mail_port')">
                  </div>
                </div>
                ...
                <div class="form-group hidemail">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control" type="text"
                      value="{{ Helper::getSettings()->site->mail_username }}" name="mail_username" required
                      id="mail_username" placeholder="@lang('admin.setting.mail_username')">
                  </div>
                </div>
                ...
                <div class="form-group hidemail">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control" type="text"
                      value="{{ Helper::getSettings()->site->mail_password }}" name="mail_password" required
                      id="mail_password" placeholder="@lang('admin.setting.mail_password')">
                  </div>
                </div>
                ...
                <div class="form-group hidemail">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control" type="email"
                      value="{{ Helper::getSettings()->site->mail_from_address }}" name="mail_from_address" required
                      id="mail_from_address" placeholder="@lang('admin.setting.mail_from_address')">
                  </div>
                </div>
                ...
                <div class="form-group hidemail">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control" type="text"
                      value="{{ Helper::getSettings()->site->mail_from_name }}" name="mail_from_name" required
                      id="mail_from_name" placeholder="@lang('admin.setting.mail_from_name')">
                  </div>
                </div>
                ...
                <div class="form-group hidemail">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control" type="text"
                      value="{{ Helper::getSettings()->site->mail_encryption }}" name="mail_encryption" required
                      id="mail_encryption" placeholder="@lang('admin.setting.mail_encryption')">
                  </div>
                </div>
                ...
                <div class="form-group hidemail mail_domain">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control" type="text" value="{{ Helper::getSettings()->site->mail_domain }}"
                      name="mail_domain" id="mail_domain" placeholder="@lang('admin.setting.mail_domain')">
                  </div>
                </div>
                ...
                <div class="form-group hidemail mail_secret">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control" type="text" value="{{ Helper::getSettings()->site->mail_secret }}"
                      name="mail_secret" id="mail_secret" placeholder="@lang('admin.setting.mail_secret')">
                  </div>
                </div>
              </div>
            </div>
            <div id="sms" class="col-md-12 row ">
              <div class="col-md-12">
                <div class="form-group" id="sms_request">
                  ...
                  <br>
                  <div class="custom-control custom-toggle">
                    <input type="checkbox" id="sendsmsCheck" name="send_sms" class="custom-control-input"
                      value ='0' {{ Helper::getSettings()->site->send_sms == '1' ? 'checked' : '' }}>
                ...
                <div class="form-group hidesms">
                  ...
                  <div class="col-xs-9">
                    <select class="form-control" name="sms_driver" required id="sms_driver">
                      ...
                      <option value="TWILIO"
                        {{ Helper::getSettings()->site->sms_provider == 'TWILIO' ? 'selected' : '' }}>@lang('admin.setting.twilio')
                      </option>
                      <option value="MSG91"
                        {{ Helper::getSettings()->site->sms_provider == 'MSG91' ? 'selected' : '' }}>@lang('admin.setting.msg91')
                      </option>
                    </select>
                  </div>
                </div>
                <div class="form-group hidesms twilInputs">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control" type="text"
                      value="{{ Helper::getSettings()->site->sms_account_sid }}" name="sms_account_sid" required
                      id="sms_account_sid" placeholder="@lang('admin.setting.twilio_settings.sms_twilio_sid')">
                  </div>
                </div>
                <div class="form-group hidesms twilInputs">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control" type="text"
                      value="{{ Helper::getSettings()->site->sms_auth_token }}" name="sms_auth_token" required
                      id="sms_auth_token" placeholder="@lang('admin.setting.twilio_settings.sms_auth_token')">
                  </div>
                </div>
                <div class="form-group hidesms twilInputs">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control" type="text"
                      value="{{ Helper::getSettings()->site->sms_from_number }}" name="sms_from_number" required
                      id="sms_from_number" placeholder="@lang('admin.setting.twilio_settings.sms_from_number')">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-xs-12">
              ...
              <div class="col-md-12">
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control" type="file" value="" name="user_pem" id="user_pem"
                      autocomplete="off" placeholder="@lang('admin.setting.ios_push_user_pem')">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control" type="file" value="" name="provider_pem" id="provider_pem"
                      autocomplete="off" placeholder="@lang('admin.setting.ios_push_provider_pem')">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control" type="text"
                      value="{{ Helper::getSettings()->site->ios_push_password }}" name="ios_push_password" required
                      id="ios_push_password" placeholder="@lang('admin.setting.ios_push_password')">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control" type="text"
                      value="{{ Helper::getSettings()->site->android_push_key }}" name="android_push_key" required
                      id="android_push_key" placeholder="@lang('admin.setting.android_push_key')">
                  </div>
                </div>
                @if (Helper::getDemomode() == 0)
                  <button class="btn btn-success nextBtn btn-lg" type="submit">Submit</button>
            ...
            <div class="form-group row">
              ...
              @foreach (Helper::getSettings()->payment as $key => $payment)
                <div class="col-md-12">
                  ...
                  <br>
                  <div class="custom-control custom-toggle">
                    <input type="hidden" name ="payment_name[]" value="{{ $payment->name }}"
                      autocomplete="off" /><br>
                    <input {{ $payment->status == '1' ? 'checked' : '' }} type="checkbox" id="{{ $payment->name }}"
                      name="payment_status[{{ $payment->name }}]" class="custom-control-input" value ='1'
                      autocomplete="off">
                    ...
                    <div class="row pay-form">
                      ...
                      @foreach ($payment->credentials as $credential)
                        <div class="col-md-6 credentials " data-id={{ $key }}>
                          <label
                            for="{{ $credential->name }}">{{ ucwords(str_replace('_', ' ', $credential->name)) }}</label>
                          <input type="hidden" name ="payment_key_name[]" value="{{ $credential->name }}"
                            autocomplete="off" /><br>
                          <input type="text" class="form-control" id="{{ $credential->name }}"
                            name ="payment_key_value[]" placeholder="Secret key" value="{{ $credential->value }}"
                            autocomplete="off">
                        </div>
                      @endforeach
                    </div>
            ...
            <div id="service" class="row setup-content edu_form form_bdy">
              <div class="col-xs-12">
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    <label for="service_accept_timeout" class="col-xs-3 col-form-label">@lang('admin.setting.Provider_Accept_Timeout')
                      (Secs)</label>
                    <div class="col-xs-9">
                      <input class="form-control number" type="text"
                        value="{{ Helper::getSettings()->service->provider_select_timeout }}"
                        name="service_provider_select_timeout" required id="service_accept_timeout"
                        placeholder="@lang('admin.setting.Provider_Accept_Timeout')">
                    </div>
                  </div>

                  <div class="form-group">
                    <label for="service_search_radius" class="col-xs-3 col-form-label">@lang('admin.setting.Provider_Search_Radius')
                      (Miles)</label>
                    <div class="col-xs-9">
                      <input class="form-control number" type="text"
                  ...
                  <div class="form-group">
                    ...
                    <br>
                    <div class="custom-control custom-toggle">
                      <input {{ Helper::getSettings()->service->serve_otp == '1' ? 'checked' : '' }} type="checkbox"
                        id="customToggle_sotp" name="service_serve_otp" class="custom-control-input" value ='1'>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xs-8">
                      <input class="form-control" type="text"
                        value="{{ Helper::getSettings()->service->booking_prefix }}" id="service_booking_prefix"
                        name="service_booking_prefix" required placeholder="@lang('admin.payment.booking_id_prefix')">
                    </div>
                  </div>
            ...
            <div class="col-xs-12">
              <div class="col-md-12">
                <div class="form-group" id="referral_request">
                  ...
                  <br>
                  <div class="custom-control custom-toggle">
                    <input {{ Helper::getSettings()->site->referral == '1' ? 'checked' : '' }} type="checkbox"
                      id="referral" name="referral" class="custom-control-input" value ='1'>
                ...
                <div class="form-group hidereferral">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control number" type="text"
                      value="{{ Helper::getSettings()->site->referral_count }}" name="referral_count" required
                      id="referral_count" placeholder="@lang('admin.setting.referral_count')" min="0">
                  </div>
                </div>
                ...
                <div class="form-group hidereferral">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control price" type="text"
                      value="{{ Helper::getSettings()->site->referral_amount }}" name="referral_amount" required
                      id="referral_amount" placeholder="@lang('admin.setting.referral_amount')">
                  </div>
                </div>
                ...
                <div class="form-group ">
                  ...
                  <div class="col-xs-9">
                    <input class="form-control " type="text" value="<?php echo isset(Helper::getSettings()->site->country_code) ? Helper::getSettings()->site->country_code : 'in'; ?>" name="country_code"
                      required id="country_code" placeholder="@lang('admin.setting.Country_code')">
                  </div>
                </div>
