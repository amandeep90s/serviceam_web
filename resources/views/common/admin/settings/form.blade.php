            ...
            <div class="registration_form basic_form   setting_form">
                <div class="stepwizard">
                    <div class="stepwizard-row setup-panel">
                        ...
                        <div class="stepwizard-step">
                            <a href="#company-profile" type="button" class="btn btn-default tabs btn-circle"
                                disabled="disabled">Comp.
                                Profile Links</a>

                        </div>
                        <div class="stepwizard-step">
                            <a href="#social-link" type="button" class="btn btn-default tabs btn-circle"
                                disabled="disabled">Social
                                Link Config</a>

                        </div>

                        <div class="stepwizard-step">
                            <a href="#map-sms" type="button" class="btn btn-default tabs btn-circle"
                                disabled="disabled">Map & SMS
                                Config</a>

                        </div>
                        <div class="stepwizard-step">
                            <a href="#mail" type="button" class="btn btn-default tabs btn-circle"
                                disabled="disabled">Mail Config</a>

                        </div>
                        <div class="stepwizard-step">
                            <a href="#push" type="button" class="btn btn-default tabs btn-circle"
                        ...
                        @if (Helper::checkService('SERVICE'))
                            <div class="stepwizard-step">
                                <a href="#service" type="button" class="btn btn-default tabs btn-circle"
                                    disabled="disabled">Service</a>
                            </div>
                        @endif
                        ...
                        <div class="stepwizard-step">
                            <a href="#others" type="button" class="btn btn-default tabs btn-circle"
                                disabled="disabled">Others</a>
                                ...
                                <div class="form-row">
                                    <div class="col-xl-6">
                                        ...
                                        <input type="file" accept="image/*" name="site_icon"
                                            class="dropify form-control-file" autocomplete="off" id="site_icon"
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <input type="file" accept="image/*" name="site_logo"
                                            class="dropify form-control-file" autocomplete="off" id="site_logo"
                                            aria-describedby="fileHelp">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-toggle">
                                        <input {{ Helper::getSettings()->site->social_login == '1' ? 'checked' : '' }}
                                            type="checkbox" id="social_login" name="social_login"
                                            class="custom-control-input social_login" value ='1'>
                                ...
                                <div class="form-group" id="mail_request">
                                    ...
                                    <div class="custom-control custom-toggle">
                                        <input {{ Helper::getSettings()->site->send_email == '1' ? 'checked' : '' }}
                                            type="checkbox" id="sendmailCheck" name="send_email"
                                ...
                                <div class="form-group" id="sms_request">
                                    ...
                                    <div class="custom-control custom-toggle">
                                        <input type="checkbox" id="sendsmsCheck" name="send_sms"
                                            class="custom-control-input" value ='0'
                                            {{ Helper::getSettings()->site->send_sms == '1' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="custom-control custom-toggle">
                                        <input type="hidden" name ="payment_name[]" value="{{ $payment->name }}"
                                            autocomplete="off" /><br>
                                        <input {{ $payment->status == '1' ? 'checked' : '' }} type="checkbox"
                                            id="{{ $payment->name }}" name="payment_status[{{ $payment->name }}]"
                                            class="custom-control-input" value ='1' autocomplete="off">
                                        ...
                                        <div class="row pay-form">
                                            ...
                                            @foreach ($payment->credentials as $credential)
                                                <div class="col-md-6 credentials " data-id={{ $key }}>
                                                    ...
                                                    <input type="hidden" name ="payment_key_name[]"
                                                        value="{{ $credential->name }}" autocomplete="off" /><br>
                                                    <input type="text" class="form-control"
                                                        id="{{ $credential->name }}" name ="payment_key_value[]"
                                                        placeholder="Secret key" value="{{ $credential->value }}"
                                                        autocomplete="off">
                                                </div>
                                            @endforeach
                                        </div>
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <div class="custom-control custom-toggle">
                                            <input {{ Helper::getSettings()->service->serve_otp == '1' ? 'checked' : '' }}
                                                type="checkbox" id="customToggle_sotp" name="service_serve_otp"
                                ...
                                <div class="form-group" id="referral_request">
                                    ...
                                    <div class="custom-control custom-toggle">
                                        <input {{ Helper::getSettings()->site->referral == '1' ? 'checked' : '' }}
                                            type="checkbox" id="referral" name="referral" class="custom-control-input"
                                            value ='1'>
            ...
            $('.nextBtn').on('click', function(e) {
                ...
                if ($(this).closest('form').hasClass('payment-setting')) {
                    $(this).closest('form').find('.credentials input').each(function() {
                        var value = $(this).closest('.credentials').data('id') + "_" + $(this)
                            .val();
                        $(this).val(value);
                    });
                }
                ...
                if ($(this).closest('form').hasClass('payment-setting')) {
                    $(this).closest('form').find('.credentials input').each(function() {
                        var value = ($(this).val()).replace($(this).closest('.credentials').data(
                            'id') + "_", "");
                        $(this).val(value);
                    });
                }
