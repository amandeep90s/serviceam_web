    ...
    table = table.DataTable({
      ...
      "ajax": {
        ...
        data: function(data) {
          ...
          data.order_by = $(tableName1 + ' tr').eq(0).find('th').eq(data.order[0][
            'column'
          ]).data('value');
      ...
      "columns": [{
        ...
        },
        {
          ...
          render: function(data, type, row) {
            ...
            return row.provider ? row.provider.currency_symbol + row.amount.toFixed(
              2) : row.user.currency_symbol + row.amount.toFixed(2);
          }
        },
        {
          "data": "created_time",
