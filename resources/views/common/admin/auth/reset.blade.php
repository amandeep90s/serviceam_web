            ...
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    <div class="basic_form login_form">
                        ...
                        <h1 id ="login_status">Reset your password</h1>
                            ...
                            <div class="form_bdy admin active_form">
                                <form class="validateForm">
                                    <div class="col-md-12 p-0 ">
                                        ...
                                        <input id="email" name="username" type="hidden" aria-required="true"
                                            value="{{ $urlparam['email'] }}">
                                        <input id="enterOtp" name="otp" class="form-control mb-4"
                                            placeholder="Enter Temporary Password" type="text" aria-required="true">
                                        <input id="newPass" name="password" class="form-control mb-4"
                                            placeholder="New Password" type="password" aria-required="true">
                                        <input id="confirmPass" name="password_confirmation" class="form-control mb-4"
                                            placeholder="Confirm Password" type="password" aria-required="true">

                                        <button type="submit"
                                            class="btn btn-block btn-secondary btn-md mb-2 signup">Continue<i
                                                class="fa fa-arrow-circle-right ml-2" aria-hidden="true"></i></button>
                                    </div>
                                </form>
                                <div class="mt-4">
                                    <a href="{{ url('admin/login') }}" id="sign" class="txt-secondary sign-up-link"><i
                                            class="fa fa-arrow-circle-left mr-2" aria-hidden="true"></i>Back To Login</a>
                                </div>
                            </div>
                        </div>
                    </div>
