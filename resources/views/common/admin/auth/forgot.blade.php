            ...
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    <div class="basic_form login_form">
                        ...
                        <h4 id ="login_status">Forgotten your password?</h4>
                                    ...
                                    <form class=" login-section validateForm">
                                        <div class="col-md-12 p-0 ">
                                            ...
                                            <input id="email" name="email" class="form-control mb-4"
                                                placeholder="E-mail Address" type="email" aria-required="true" required>
                                            ...
                                            <a href="{{ url('admin/login') }}" id="sign"
                                                class="txt-secondary sign-up-link"><i class="fa fa-arrow-circle-left mr-2"
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        ...
                        success: function(response, textStatus, jqXHR) {
                            ...
                            para = '?email=' + response.responseData.username + '&type=' +
                                response.responseData.account_type;
                            // setToken("user", response.responseData.access_token);
                            // setUserDetails(response.responseData.user);
                            window.location.replace("{{ url('/admin/resetPassword') }}" +
                                para);
                            hideLoader();
                        },
