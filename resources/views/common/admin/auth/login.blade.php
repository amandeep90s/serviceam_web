                ...
                <div class="col-md-12 col-lg-12">
                    <div class="basic_form login_form">
                        ...
                        <div class="dis-center" style="margin-bottom: 10px;">
                            <img id="main-logo" class="d-inline-block align-top mr-1" src="{{ Helper::getSiteLogo() }}"
                        ...
                        <div class="form_cnt">
                            <div class="form_bdy admin active_form">
                                <form role="form" class="validateForm">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="basic_tpy_sec"><input maxlength="100" type="text" required="required"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="basic_tpy_sec"><input maxlength="100" type="password"
                                                required="required" id="password" name="password" class="form-control"
                            ...
                            <span>Forgot your Password?
                                <strong>
                                    <a href="javascript:;" class="signup-link forgotPassword"> <span
                                            class="txt-label pl-2">Reset Here</span></a>
                                </strong>
                            </span>
                        </div>
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        ...
                        success: function(response, textStatus, jqXHR) {
                            ...
                            $.ajax({
                                url: "/admin/permission_list/" + data.responseData
                                    .user.id + "/token/" + getToken("admin"),
                                type: "get",
                                processData: false,
                                contentType: false,
                                success: function(response, textStatus, jqXHR) {
