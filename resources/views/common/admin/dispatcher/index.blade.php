...
@section('title') Dispatcher Panel @stop
  ...
  <div class="main-content-container container-fluid px-4">
    <div class="page-header row no-gutters py-4">
      <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
        <span class="text-uppercase page-subtitle">Dispatcher Panel</span>
        <h3 class="page-title">Dispatcher Panel</h3>
      </div>
    </div>
      ...
      <div class="col-md-12">
        <div class="card card-small">
          <div class="card-header border-bottom">
            <h6 class="m-0">Dispatcher Panel</h6>
            <div class="col-md-12">
              <div class="note_txt">
          ...
          <div class="col-md-12">
            <div class="tabs">
              <div class="tab-button-outer">
                <ul id="tab-button">
                  <li class="is-active"><a><i class="fa fa-search"></i> Searching</a></li>
                  <li><a><i class="fa fa-user" aria-hidden="true"></i> Assigned</a></li>
                  <li><a><i class="fa fa-times" aria-hidden="true"></i> Cancelled</a></li>
                  <li><a><i class="fa fa-plus" aria-hidden="true"></i> Add</a></li>
                </ul>
              </div>
              <div class="tab-select-outer">
                <select id="tab-select">
                  <option value="#tab01"><i class="fa fa-times" aria-hidden="true"></i> Searching</option>
                  <option value="#tab02"><i class="fa fa-times" aria-hidden="true"></i> Cancelled</option>
                  <option value="#tab03"><i class="fa fa-plus" aria-hidden="true"></i> Add</option>
                </select>
              </div>
              <div id="tab01" class="tab-contents row">
                <div class="col-md-4">
                  <div class="tab_sub_title">
                    <h6 class="m-0">Searching List</h6>
                  </div>
                  <div class="tab_body fnt_weight_400">
                    ...
                    <p class="font_14">To: Mathuthavani Praking Lot, Tiruchirappalli Bus Bay, Madurai, Tamil Nadu, India
                    </p>
              ...
              <div id="tab02" class="tab-contents row d-none">
                <div class="col-md-4">
                  <div class="tab_sub_title">
                    <h6 class="m-0">Cancelled List</h6>
                  </div>
                  <div class="tab_body fnt_weight_400">
                  ...
                  <form>
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="fePassword" placeholder="Phone">
                      </div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-accent float-right">Submit</button>
                  </form>
                </div>
                <div class="col-md-8">
                  <div class="tab_sub_title">
            ...
            render: function(data, type, row) {
              if ({{ Helper::getDemomode() }} != 1) {
                return "<button data-id='" + data +
                  "' class='btn btn-block btn-success edit'>Edit</button> <button data-id='" + data +
                  "' class='btn btn-block btn-danger delete'>Delete</button>";
              }
            }
          }
