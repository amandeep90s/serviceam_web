    ...
    <div class="main-content-container container-fluid px-4">
        <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                <span class="text-uppercase page-subtitle">{{ $type }} Manager</span>
                <h3 class="page-title">{{ $type }} Manager List</h3>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card card-small">
                    <div class="card-header border-bottom">
                        <h6 class="m-0 pull-left">{{ $type }} Manager</h6>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '.edit', function(e) {
                e.preventDefault();
                $.get("{{ url('admin/subadmin/') }}/" + $(this).data('id') + "/edit/{{ $type }}",
                    function(
                        data) {
                        $('.crud-modal .modal-container').html("");
                        $('.crud-modal .modal-container').html(data);
            ...
            $('body').on('click', '.status', function() {
                ...
                $(".status-modal-btn")
                    ...
                    .on("click", function() {
                        ...
                        var url = getBaseUrl() + "/admin/subadmin/" + id + '/updateStatus?status=' +
                            value;
