<div class="row mb-4">
  <div class="col-md-12">
    <div class="card-header border-bottom">
      ...
      @endif
      <h6 class="m-0"style="margin:10!important;">{{ $action_text }} {{ $type }}</h6>
    </div>
    <div class="form_pad">
      <form class="validateForm">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            <label for="name" class="col-xs-2 col-form-label">{{ $type }}
          ...
          <div class="form-group col-md-6 email">
            <label for="email" class="col-xs-2 col-form-label">{{ $type }} {{ __('admin.email') }}</label>
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            <label for="password" class="col-xs-2 col-form-label">{{ $type }} {{ __('admin.password') }}</label>
            <input type="password" class="form-control" id="password" name="password" placeholder="Password"
              value="" autocomplete="off">
          </div>
          <div class="form-group col-md-6">
            <label for="password_confirmation">{{ $type }} {{ __('admin.password_confirmation') }}</label>
        ...
        @endif
        <button type="submit" class="btn btn-accent">{{ $action_text }} {{ $type }}</button>
      ...
      success: function(data) {
        ...
        if (data.responseData.length != 0) {
          ...
          $.each(data.responseData, function(key, item) {
            html += ('<div class="radio"><label><input type="radio" name="role" id="role_id" value="' +
