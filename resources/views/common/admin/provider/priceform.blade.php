  ...
  <div class="col-md-8 box-card price_lists_sty priceBody">
    ...
    <div class="col-xs-12">
      ...
      <nav class="nav_document">
        <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
          <a class="nav-item nav-link active" id="nav-daily-tab" data-toggle="tab" href="#daily" role="tab"
            aria-controls="daily" aria-selected="true">Provider Document</a>
        </div>
      </nav>
      ...
      success: function(datas) {
        ...
        if (providerdetails.providerservice.length > 0) {
          ...
          $.each(services, function(k, servicename) {
            servicenames += `<a href="#" class="list-group-item cityActiveClass" onclick="getData('` +
              servicename + `')" ><span>` + servicename.charAt(0).toUpperCase() + servicename.slice(1)
              .toLowerCase() + `</span></a>`;
          });
