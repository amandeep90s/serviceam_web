...
<html class="no-js h-100" lang="en">
    ...
    <head>
        ...
        @section('styles')
            ...
            <link rel="stylesheet" type='text/css'
                href="{{ asset('assets/plugins/intl-tel-input/css/intlTelInput.min.css') }}" />
                            ...
                            <a class="navbar-brand w-100 mr-0" href="{{ url('/admin/dashboard') }}">
                                <div class="d-table" style="margin-left: 24px;">
                                    <img id="main-logo" class="d-inline-block align-top mr-1"
                                        src="{{ Helper::getSiteLogo() }}" alt="Logo"
                                        style="max-width: 100%;height: 40px;">
                                    <!-- <span class="d-none d-md-inline ml-1" style="line-height: 3"> @if (isset(Helper::getSettings()->site->site_title))
...
@endif
                        ...
                        <nav class="navbar align-items-stretch navbar-light flex-md-nowrap p-0">
                            <form action="#" class="main-navbar__search w-100 d-none d-md-flex d-lg-flex">
                                ...
                                <div class="alert alert-danger alert-dismissible is_bankdetails  fade in">
                                    ...
                                    <strong>Please Fill Bank Details</strong><a
                                        href="{{ URL::to('admin/bankdetails') }}">click here</a>.
                                </div>
                              ...
                              <div class="nav-link-icon__wrapper">
                                 ...
                                 <span class="badge badge-pill badge-danger">2</span>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-small" aria-labelledby="dropdownMenuLink">
                                        ...
                                        <a class="dropdown-item notification__all text-center" href="#"> View
                                            all Notifications </a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown" style="text-align: center;">
                                    <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown"
                                        ...
                                        <img class="user_picture rounded-circle mr-2" src="" alt="Profile"
                                            style="width: 40px;">
        ...
        @section('scripts')
            ...
            <script type="text/javascript" src="{{ asset('assets/plugins/intl-tel-input/js/intlTelInput-jquery.min.js') }}">
            </script>
        ...
        <script>
            ...
            if ("{{ Session::get('user_id') }}" == "") {
                $.ajax({
                    url: "/admin/permission_list/" + adminSettings.id + "/token/" + getToken("admin"),
                    type: "get",
                    processData: false,
                    contentType: false,
