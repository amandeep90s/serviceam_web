...
@section('title') Provider Reviews @stop
    ...
    <div class="main-content-container container-fluid px-4">
        <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                <span class="text-uppercase page-subtitle">Provider Reviews</span>
                <h3 class="page-title">Provider Reviews</h3>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card card-small">
                    <div class="card-header border-bottom">
                        <h6 class="m-0">Provider Reviews</h6>
                    </div>
                    ...
                    <table id="data-table" class="table table-hover table_width display">
                        <thead>
                            <tr>
                                ...
                                <th data-value="provider_comment">{{ __('admin.review.Comments') }}</th>
        ...
        $(document).ready(function() {
            $('body').on('click', '.view', function(e) {
                ...
                if ($(this).data('service') == "TRANSPORT") {
                    ...
                    $.get("{{ url('admin/riderequestdetails/') }}/" + $(this).data('id') + "/view",
                        function(data) {
                    ...
                    $.get("{{ url('admin/order-requestdetails/') }}/" + $(this).data('id') + "/view",
                        function(data) {
                            $('.crud-modal .modal-container').html("");
                            $('.crud-modal .modal-container').html(data);
                        });
            ...
            table = table.DataTable({
                ...
                "columns": [{
                    ...
                    },
                    {
                        "data": "id",
                        render: function(data, type, row) {
                            return "<button data-id='" + data + "' data-service='" + row
                                .admin_service +
                                "' class='btn btn-block btn-success view'>view</button>";
                        }
                    }
