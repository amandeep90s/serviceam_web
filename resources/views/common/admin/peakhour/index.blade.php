  ...
  <div class="main-content-container container-fluid px-4">
    <div class="page-header row no-gutters py-4">
      <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
        <span class="text-uppercase page-subtitle">PeakHour</span>
        <h3 class="page-title">PeakHour List</h3>
      </div>
    </div>
      ...
      <div class="col-md-12">
        <div class="card card-small">
          <div class="card-header border-bottom">
            <h6 class="m-0 pull-left">PeakHour</h6>

            <a href="javascript:;" class="btn btn-success pull-right add"><i class="fa fa-plus"></i> Add New PeakHour</a>
          ...
          <table id="data-table" class="table table-hover table_width display">
            <thead>
              <tr>
                ...
                <th data-value="start_time">@lang('admin.peakhour.start_time') </th>
                <th data-value="end_time">@lang('admin.peakhour.end_time') </th>
                <th data-value="city">@lang('admin.peakhour.city') </th>
                <th data-value="timezone">@lang('admin.peakhour.timezone') </th>
                <th data-value="status">@lang('admin.notification.notify_status') </th>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $('.add').on('click', function(e) {
        e.preventDefault();
        $.get("{{ url('admin/peakhour/create') }}", function(data) {
      ...
      $('body').on('click', '.edit', function(e) {
        e.preventDefault();
        $.get("{{ url('admin/peakhour/') }}/" + $(this).data('id') + "/edit", function(data) {
          $('.crud-modal .modal-container').html("");
          $('.crud-modal .modal-container').html(data);
        });
        $('.crud-modal').modal('show');
