                    ...
                    <table id="data-table" class="table table-hover table_width display">
                        <thead>
                            <tr>
                                ...
                                <th data-value="start_time">{{ __('admin.peakhour.start_time') }}</th>
                                <th data-value="end_time">{{ __('admin.peakhour.end_time') }}</th>
                                <th data-value="city">{{ __('admin.peakhour.city') }}</th>
                                <th data-value="timezone">{{ __('admin.peakhour.timezone') }}</th>
                                <th data-value="status">{{ __('admin.notification.notify_status') }}</th>
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            return "<button data-id='" + data +
                                "' class='btn btn-block btn-success edit'>Edit</button> <button data-id='" +
                                data +
