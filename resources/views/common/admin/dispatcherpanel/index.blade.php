  ...
  <div class="main-content-container container-fluid px-4">
    ...
    <div class="page-header row no-gutters py-4">
      <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
        ...
        <h3 class="page-title">Dispatcher</h3>
      </div>
    </div>
    <!-- TabMenu Start -->
...
@section('scripts')
  ...
  <script crossorigin src="{{ asset('assets/plugins/babel.min.js') }}"></script>
  <!-- <script crossorigin src="{{ asset('assets/plugins/react/production/react.production.min.js') }}"></script>
  <script crossorigin src="{{ asset('assets/plugins/react/production/react-dom.production.min.js') }}"></script> -->


  <script crossorigin src="{{ asset('assets/plugins/react/development/react.development.js') }}"></script>
  <script crossorigin src="{{ asset('assets/plugins/react/development/react-dom.development.js') }}"></script>
  ...
  <script
    src="https://maps.googleapis.com/maps/api/js?key={{ Helper::getSettings()->site->browser_key }}&libraries=places"
    async defer></script>
