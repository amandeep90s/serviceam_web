            ...
            <div class="col-md-12">
                <div class="card card-small">
                    <div class="card-header border-bottom">
                        <h6 class="m-0 pull-left" style="margin:10!important;">City</h6>

                        <a href="javascript:;" class="btn btn-success pull-right add" style="margin:10!important;"><i
                                class="fa fa-plus"></i> Add New City</a>
                    ...
                    <table id="data-table" class="table table-hover table_width display">
                        <thead>
                            <tr>
                                ...
                                <th data-value="country_id">@lang('admin.city.country')</th>
                                <th data-value="state_id">@lang('admin.city.state')</th>
                                <th data-value="city_id">@lang('admin.city.city')</th>
                                <!--  <th data-value="admin_service">@lang('admin.city.admin_service')</th> -->
                                <th data-value="status">@lang('admin.city.status')</th>
        ...
        function myFunction(event) {
            ...
            $.each(event.city_service, function(key, row) {
                ...
                if (key == 0) {
                    ...
                    active = "show active";
                    alert
                    navActive = "active show";
                    alert
                }
                alert
                nav += `<a class="nav-item nav-link ` + nalertavActive +
                    `" id="nav-daily-tab" data-toggle="tab" href="#` + row.admin_service.display_name +
                    `" role="tab" aria-controls="daily" aria-selected="` + ariaSelected + `">` + row.admin_service
                    .display_name + `</a>`;
                alert
                body += ` <form class="form" id="` + rowalert.admin_service.display_name + `" >
            <div class="tab-pane fade` + active + ` id="` + row.admin_service.display_name +
                    `" role="tabpanel" aria-labelledby="nav-` + row.admin_service.display_name + `-tab">
                    ...
                    <div class="form-group col-md-12">
                        <div class="col-xs-10">
                            <div class="row">
                                ...
                                <button type="submit" class="btn btn-accent float-right addService" id="` + row
                    .admin_service.display_name + `">Add Commission</button>
                                </div>
                            </div>
                        </div>
                    </div>
