...
@section('content')
  ...
  <div class="modal fade bs-modal-lg complete-modal" tabindex="-1" role="basic" aria-hidden="true" data-backdrop="static"
    data-keyboard="false">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" data-value="1" class="btn btn-danger complete-modal-btn">Confirm</button>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>
  ...
  <div class="main-content-container container-fluid px-4">
    <div class="page-header row no-gutters py-4">
      <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
        <span class="text-uppercase page-subtitle">Payroll</span>
      ...
      <div class="col-md-12">
        <div class="card card-small">
          <div class="card-header border-bottom">
            <h6 class="m-0 pull-left">Payroll</h6>
            @if (Helper::getDemomode() != 1)
              <a href="javascript:;" class="btn btn-success pull-right add new_user"><i class="fa fa-plus"></i> Add New
                Payroll</a>
            @endif
          </div>
              ...
              if ({{ Helper::getDemomode() }} != 1) {
                if (data.status != "COMPLETED") {
                  button += `<li><a href="javascript:;" data-id="` + data.id +
                    `" class="dropdown-item complete"><i class="fa fa-edit"></i> Complete</a> </li>`;
                }
                button += `<li><a href="javascript:;" data-id="` + data.transaction_id + `" class="dropdown-item delete"><i class="fa fa-trash"></i> Delete</a> </li>
                        <li><a href="` + getBaseUrl() + `/admin/payrolls/download/` + data.transaction_id +
                  `" data-id="` + data.transaction_id +
                  `" class="dropdown-item "><i class="fa fa-database"></i> Download</a> </li>`;
              }
              button += `</ul> </li></div>`;
              return button;
