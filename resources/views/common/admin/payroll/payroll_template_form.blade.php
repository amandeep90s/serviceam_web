<div class="row mb-4">
  <div class="col-md-12">
    <div class="card-header border-bottom">
      ...
      @endif
      <h6 class="m-0" style="margin:10!important;"> {{ $action_text }} Payroll Template</h6>
    </div>
    <div class="form_pad">
      <form class="validateForm" files="true">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="template_name" name="template_name" placeholder="Name"
        ...
        <br>
        <button type="submit" class="btn btn-accent">{{ $action_text }} Payroll Template</button>
