    ...
    <div class="main-content-container container-fluid px-4 mt-20">
        <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                <span class="text-uppercase page-subtitle">CmsPage</span>
                <h3 class="page-title">CmsPage List</h3>
            </div>
        </div>
        <div class="col-md-12">
            <div class="note_txt">
            ...
            <div class="col-md-12">
                <div class="card card-small">
                    <div class="card-header border-bottom">
                        <h6 class="m-0 pull-left">CmsPage</h6>

                        <a href="javascript:;" class="btn btn-primary pull-right add new_user"><i class="fa fa-plus"></i>
                            Add New CmsPage</a>
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            return "<button data-id='" + data +
                                ...
                                data + "' class='btn btn-block btn-danger delete'>Delete</button>";
                        }
                    }
