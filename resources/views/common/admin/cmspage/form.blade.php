    ...
    <div class="main-content-container container-fluid px-4">
        <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                <span class="text-uppercase page-subtitle">ADD Cms Page</span>
                        ...
                        <form class="validateForm">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="name"
                                        class="col-xs-2 col-form-label">{{ __('admin.pages.name') }}</label>
                                    <select name="page_name" id="page_name" class="form-control">
                                        ...
                                        <option value="work_with_us">Works With Us</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-row">
