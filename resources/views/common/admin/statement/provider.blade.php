          ...
          },
          {
            ...
            render: function(data, type, row) {
              if (row.status = "approved") {
                return `<span class="tag tag-success">` + row.status.charAt(0).toUpperCase() + row.status
                  .slice(1) + `</span>`;
              } else if (row.status = "banned") {
                return `<span class="tag tag-danger">` + row.status.charAt(0).toUpperCase() + row.status
                  .slice(1) + `</span>`;
              } else {
                return `<span class="tag tag-info">` + row.status.charAt(0).toUpperCase() + row.status.slice(
                  1) + `</span>`;
              }
