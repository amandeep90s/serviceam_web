  ...
  <div class="col-md-12">
    ...
    <div class="p-2">
      <form class="validateForm">
        ...
        <div class="form-row">
          <div class="form-group col-md-10">
            <label for="title" class="col-xs-2 col-form-label">@lang('admin.notification.days')</label>
            <input type="number" class="form-control" autocomplete="off" value="{{ old('days') }}" name="days"
              required id="days" placeholder="@lang('admin.notification.days')">
          </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-10">
