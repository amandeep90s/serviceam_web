                    ...
                    <table id="data-table" class="table table-hover table_width display">
                        <thead>
                            <tr>
                                ...
                                <th data-value="notify_type">{{ __('admin.notification.notify_type') }}</th>
                                <th data-value="desc">{{ __('admin.notification.notify_desc') }}</th>
                                <th data-value="expiry_date">{{ __('admin.notification.notify_expiry') }}</th>
