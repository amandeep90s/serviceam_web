      ...
      <form class="validateForm">
        ...
        <div class="form-row">
          <div class="form-group col-md-10">
            ...
            <input type="text" class="form-control" autocomplete="off" value="{{ old('title') }}" name="title"
              required id="title" placeholder="@lang('admin.notification.notify_title')">
          </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-10">
            ...
            <input type="text" class="form-control" autocomplete="off" value="{{ old('description') }}"
              name="descriptions" required id="description" placeholder="@lang('admin.notification.notify_desc')">
          </div>
        </div>
        ...
        <div class="form-row">
          <div class="form-group col-md-10">
            ...
            <input class="form-control" autocomplete="off" type="text" value="{{ old('expiry_date') }}"
              name="expiry_date" required id="datetimepicker" placeholder="@lang('admin.notification.notify_expiry')">
          </div>
        </div>
