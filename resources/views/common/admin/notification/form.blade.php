<div class="row mb-4">
    <div class="col-md-12">
        <div class="card-header border-bottom">
            ...
            @endif
            <h6 class="m-0" style="margin:10!important;">{{ $action_text }} Notification</h6>
        </div>
        <div class="p-2">
            <form class="validateForm">
                ...
                <div class="form-row">
                    <div class="form-group col-md-10">
                        <label for="notify_type"
                            class="col-xs-2 col-form-label">{{ __('admin.notification.notify_type') }}
                        </label>
                ...
                <div class="form-row">
                    <div class="form-group col-md-10">
                        <label for="title"
                            class="col-xs-2 col-form-label">{{ __('admin.notification.notify_title') }}</label>
                        <input type="text" class="form-control" autocomplete="off" value="{{ old('title') }}"
                            name="title" required id="title"
                            placeholder="{{ __('admin.notification.notify_title') }}">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-10">
                        <label for="desc"
                            class="col-xs-2 col-form-label">{{ __('admin.notification.notify_desc') }}</label>
                        <input type="text" class="form-control" autocomplete="off" value="{{ old('description') }}"
                            name="descriptions" required id="description"
                            placeholder="{{ __('admin.notification.notify_desc') }}">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-10">
                        <label for="datetimepicker"
                            class="col-xs-2 col-form-label">{{ __('admin.notification.notify_expiry') }}</label>
                        <input class="form-control" autocomplete="off" type="text" value="{{ old('expiry_date') }}"
                            name="expiry_date" required id="datetimepicker"
                            placeholder="{{ __('admin.notification.notify_expiry') }}">
                    </div>
                </div>
                ...
                <br>
                <button type="submit" class="btn btn-accent">{{ $action_text }} Notification</button>
    ...
    $(document).ready(function() {
        ...
        $('.validateForm').validate({
            ...
            messages: {
                ...
                description: {
                    required: "Notify Description is required."
                },
                notify_expiry: {
