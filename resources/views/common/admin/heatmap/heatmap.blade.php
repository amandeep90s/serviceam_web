      ...
      <div class="box box-block bg-white">
            ...
            <div class="tab-button-outer">
              <ul id="tab-button">
                @foreach (Helper::getServiceList() as $service)
                  <li class="services" data-type="{{ strtolower($service) }}"><a
                      href="javascript:;">{{ $service }}</a></li>
                @endforeach
              </ul>
            </div>
          </div>
        ...
        <div id="tab01" class="tab-contents row p-2">
          <div class="col-md-12">
            <div id="floating-panel">
              <button class="btn btn-info" onclick="toggleHeatmap(event)">Toggle Heatmap</button>
              <button class="btn btn-info" onclick="changeGradient(event)">Change gradient</button>
              <button class="btn btn-info" onclick="changeRadius(event)">Change radius</button>
              <button class="btn btn-info" onclick="changeOpacity(event)">Change opacity</button>
            </div>
            <br>
        ...
        <div class="content-box dis-center d-none">
          <div class="col-md-12 col-sm-12 col-lg-12 p-0 mt-5 dis-center">
            <h5 class="txt-primary"><strong>No Services Available</strong></h5>
          </div>
        </div>
      </div>
    </div>
