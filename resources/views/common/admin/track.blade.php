                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12 p-0">
                                ...
                                <div class="trip-user dis-ver-center col-lg-12 col-md-12 col-sm-12 mb-2">
                                    <div class="dis-column col-lg-6 col-md-6 col-sm-6 ">
                                        <div class="user-img"
                                            style="background-image: url(https://schedule.tranxit.co/storage/provider/profile/f1505bf83063da02b2106323e78be9a5.jpeg);">
                                        </div>
                                            ...
                                            <span style="cursor: default;"><span class="provider_rating">4.6</span>
                                                <div class="rating-symbol"
                                                    ...
                                                    <div class="rating-symbol-foreground"
                                                        style="display: inline-block; position: absolute; overflow: hidden; left: 0px; right: 0px;top: 0; width: auto;">
                                    ...
                                    <div class="dis-column col-lg-6 col-md-6 col-sm-6 p-0">
                                        <div class="car-img"> <img width="100" class=""
                                                src="../img/taxi/mustang.png" alt="premium">
                                        </div>
