  ...
  <div class="main-content-container container-fluid px-4">
    <div class="page-header row no-gutters py-4">
      <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
        <span class="text-uppercase page-subtitle">Dispute Reason</span>
        <h3 class="page-title">Dispute Reason List</h3>
      </div>
    </div>
      ...
      <div class="col-md-12">
        <div class="card card-small">
          <div class="card-header border-bottom">
            <h6 class="m-0 pull-left">Dispute Reason</h6>
            @permission('dispute-create')
              <a href="javascript:;" class="btn btn-primary pull-right add"><i class="fa fa-plus"></i> <strong>Add Dispute
                  Reason</strong></a>
            @endpermission
          </div>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      table = table.DataTable({
        ...
        "ajax": {
          "url": getBaseUrl() + "/admin/dispute_list",
          "type": "GET",
