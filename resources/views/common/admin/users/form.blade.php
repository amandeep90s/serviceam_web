<div class="row mb-4">
    <div class="col-md-12">
        <div class="card-header border-bottom">
            ...
            @endif
            <h6 class="m-0" style="margin:10!important;"> {{ $action_text }} User</h6>
        </div>
        <div class="form_pad">
            <form class="validateForm" files="true">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="password" class="form-control" id="password_confirmation"
                            name="password_confirmation" placeholder="Re-Type-Password" value=""
                            autocomplete="off">
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <label for="male" class="col-xl-3 col-form-label">{{ __('admin.male') }}
                            <input type="radio" class="form-control mt-2" id="male" name="gender"
                                value="MALE">
                        </label>
                        <label for="female" class="col-xl-3 col-form-label">{{ __('admin.female') }}
                            <input type="radio" class="form-control mt-2" id="female" name="gender"
                                value="FEMALE">
                        </label>
                        <div>
                ...
                <br>
                <button type="submit" class="btn btn-accent">{{ $action_text }} User</button>
