<div class="row mb-4">
    <div class="col-md-12">
        <div class="card-header border-bottom">
            ...
            @endif
            <h6 class="m-0"style="margin:10!important;">{{ $action_text }} Country</h6>
        </div>
        <div class="form_pad">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="country_id"
                            class="col-xs-2 col-form-label">{{ __('admin.country.country_name') }}</label>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="currency" name="currency"
                            placeholder="{{ __('admin.country.currency') }}" value="" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="currency_code"
                            class="col-xs-2 col-form-label">{{ __('admin.country.currency_code') }}</label>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data.responseData, function(key, item) {
                    $("#country_id").append('<option value="' + item.id + '">' + item
                        .country_name + '</option>');
                });
        ...
        $('.validateForm').validate({
            ...
            messages: {
                ...
                currency: {
                    ...
                    maxlength: "Currency should not exceed 5 digits."
                },
                currency_code: {
                    required: "Currency Code is required.",
                    maxlength: "Currency Code should not exceed 3 digits."
                },
                status: {
