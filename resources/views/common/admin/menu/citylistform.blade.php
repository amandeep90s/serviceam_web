<div class="modal-header">
    <h4 class="modal-title">Menu City List</h4>
        ...
        table = table1.DataTable({
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        if (row.city_price == 1) {
                            ...
                            return row.city.city_name +
                                " - <span style='color:red'>  (Pricing Logic Is Required)</span>";
                        }
                    }
                }
            ],
            "columnDefs": [{
                ...
                'render': function(data, type, row, meta) {
                    ...
                    if (row.city_price == 1) {
                        return '<input type="checkbox" name="city_id[]" class="dt-checkboxes dt-checked-main" ' +
                            selected + ' value="' + row.city.id + '">';
                    }
