          ...
          <div class="form-group col-md-6">
            ...
            <div class="col-xs-10">
              <input style="width: 150px;" class="form-control" autocomplete="off" type="number"
                value="{{ old('sort_order') }}" name="sort_order" required id="sort_order" placeholder="Sort Order">
            </div>
          </div>
        </div>
        <div class="form-row">
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        $.each(data.responseData, function(key, item) {
          $("#menu_type_id").append('<option value="' + item.id + '">' + item.service_category_name +
            '</option>');
        });
      ...
      if ($service_id == 'TRANSPORT') {
        $.ajax({
          ...
          success: function(data) {
            ...
            $.each(data.responseData, function(key, item) {
              $("#menu_type_id").append('<option value="' + item.id + '">' + item.ride_name +
                '</option>');
            });
      ...
      $.ajax({
        ...
        success: function(response, textStatus, jqXHR) {
          ...
          if (data.is_featured == 1) {
            ...
            $('input[name=featured_image]').closest('.image-placeholder').find('img').attr('src', data
              .featured_image);
          }
            ...
            $.ajax({
              ...
              success: function(data) {
                ...
                $.each(data.responseData, function(key, item) {
                  ...
                  $("#menu_type_id").append('<option value="' + item.id + '" ' + selected + '>' +
