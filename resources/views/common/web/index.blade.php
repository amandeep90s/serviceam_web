            ...
            <div class="dis-column col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="search-section z2 w-100 dis-reverse">
                    <div class="col-lg-6 col-md-8 col-sm-12 dis-column">
                        <input id="search" name="search" class="form-control mb-0" placeholder="Search for a service"
                    ...
                    <div id="rides" class="owl-carousel">
                            ...
                            <div class="service-list col-md-12 col-lg-12 col-sm-12 p-0">
                                <div class="service-item item-shadow">
                                    <img alt="" class="img-responsive"
                                        src="{{ asset('assets/layout/images/common/bg.jpg') }}">
                                    <div class="blog-hover"></div>
                                </div>
                                <div class="service-section">
                                    <div class="service-content">
                                        <h3 class="service-title">Taxi Ride</h3>
                                        <a href="#" target="_blank" class="link-arrow">Book Now<i
                        ...
                        <div class="item">
                            <div class="service-list col-md-12 col-lg-12 col-sm-12 p-0">
                                <div class="service-item item-shadow">
                                    <img alt="" class="img-responsive"
                                        src="{{ asset('assets/layout/images/common/car-rental.jpg') }}">
                                    <div class="blog-hover"></div>
                                </div>
                                <div class="service-section">
                                    <div class="service-content">
                        ...
                        <div class="item">
                            <div class="service-list col-md-12 col-lg-12 col-sm-12 p-0">
                                <div class="service-item item-shadow">
                                    <img alt="" class="img-responsive"
                                        src="{{ asset('assets/layout/images/common/moto-rental.jpg') }}">
                                    <div class="blog-hover"></div>
                                </div>
                                <div class="service-section">
                                    <div class="service-content">
                        ...
                        <div class="item">
                            <div class="service-list col-md-12 col-lg-12 col-sm-12 p-0">
                                <div class="service-item item-shadow">
                                    <img alt="" class="img-responsive"
                                        src="{{ asset('assets/layout/images/common/moto-ride.jpg') }} ">
                                    <div class="blog-hover"></div>
                                </div>
                                <div class="service-section">
                                    <div class="service-content">
                        ...
                        <div class="item">
                            <div class="service-list col-md-12 col-lg-12 col-sm-12 p-0">
                                <div class="service-item item-shadow">
                                    <img alt="" class="img-responsive"
                                        src="{{ asset('assets/layout/images/common/packers.jpg') }}">
                                    <div class="blog-hover"></div>
                                </div>
                                <div class="service-section">
                                    <div class="service-content">
                    ...
                    <div id="deliveries" class="owl-carousel">
                        <div class="item">
                            <div class="service-list col-md-12 col-lg-12 col-sm-12 p-0">
                                <div class="service-item item-shadow">
                                    <img alt="" class="img-responsive"
                                        src="{{ asset('assets/layout/images/common/house-cleaning.jpg') }}">
                                    <div class="blog-hover"></div>
                                </div>
                                <div class="service-section">
                                    <div class="service-content">
                        ...
                        <div class="item">
                            <div class="service-list col-md-12 col-lg-12 col-sm-12 p-0">
                                <div class="service-item item-shadow">
                                    <img alt="" class="img-responsive"
                                        src="{{ asset('assets/layout/images/common/flower.jpg') }}">
                                    <div class="blog-hover"></div>
                                </div>
                                <div class="service-section">
                                    <div class="service-content">
                        ...
                        <div class="item">
                            <div class="service-list col-md-12 col-lg-12 col-sm-12 p-0">
                                <div class="service-item item-shadow">
                                    <img alt="" class="img-responsive"
                                        src="{{ asset('assets/layout/images/common/grocary.png') }}">
                                    <div class="blog-hover"></div>
                                </div>
                                <div class="service-section">
                                    <div class="service-content">
                        ...
                        <div class="item">
                            <div class="service-list col-md-12 col-lg-12 col-sm-12 p-0">
                                <div class="service-item item-shadow">
                                    <img alt="" class="img-responsive"
                                        src="{{ asset('assets/layout/images/common/massage.jpg') }}">
                                    <div class="blog-hover"></div>
                                </div>
                                <div class="service-section">
                                    <div class="service-content">
                        ...
                        <div class="item">
                            <div class="service-list col-md-12 col-lg-12 col-sm-12 p-0">
                                <div class="service-item item-shadow">
                                    <img alt="" class="img-responsive"
                                        src="{{ asset('assets/layout/images/common//marijuana.jpg') }}">
                                    <div class="blog-hover"></div>
                                </div>
                                <div class="service-section">
                                    <div class="service-content">
                        ...
                        <div class="item">
                            <div class="service-list col-md-12 col-lg-12 col-sm-12 p-0">
                                <div class="service-item item-shadow">
                                    <img alt="" class="img-responsive"
                                        src="{{ asset('assets/layout/images/common/alcohol.jpg') }}">
                                    <div class="blog-hover"></div>
                                </div>
                                <div class="service-section">
                                    <div class="service-content">
                    ...
                    <div id="other-services" class="owl-carousel">
                        <div class="item">
                            <div class="service-list  col-md-12 col-lg-12 col-sm-12">
                                <div class="service-item item-shadow">
                                    <img alt="" class="img-responsive"
                                        src="{{ asset('assets/layout/images/common/doctor.jpg') }}">
                                    <div class="blog-hover"></div>
                                </div>
                                <div class="service-section">
                                    <div class="service-content">
                        ...
                        <div class="item">
                            <div class="service-list  col-md-12 col-lg-12 col-sm-12">
                                <div class="service-item item-shadow">
                                    <img alt="" class="img-responsive"
                                        src="{{ asset('assets/layout/images/common/baby-sitting.jpg') }}">
                                    <div class="blog-hover"></div>
                                </div>
                                <div class="service-section">
                                    <div class="service-content">
                        ...
                        <div class="item">
                            <div class="service-list col-md-12 col-lg-12 col-sm-12 p-0">
                                <div class="service-item item-shadow">
                                    <img alt="" class="img-responsive"
                                        src="{{ asset('assets/layout/images/common/beauty-service.jpg') }}">
                                    <div class="blog-hover"></div>
                                </div>
                                <div class="service-section">
                                    <div class="service-content">
                        ...
                        <div class="item">
                            <div class="service-list col-md-12 col-lg-12 col-sm-12 p-0">
                                <div class="service-item item-shadow">
                                    <img alt="" class="img-responsive"
                                        src="{{ asset('assets/layout/images/common/dog-walking.jpg') }}">
                                    <div class="blog-hover"></div>
                                </div>
                                <div class="service-section">
                                    <div class="service-content">
                        ...
                        <div class="item">
                            <div class="service-list col-md-12 col-lg-12 col-sm-12 p-0">
                                <div class="service-item item-shadow">
                                    <img alt="" class="img-responsive"
                                        src="{{ asset('assets/layout/images/common/carpenter.jpg') }}">
                                    <div class="blog-hover"></div>
                                </div>
                                <div class="service-section">
                                    <div class="service-content">
                        ...
                        <div class="item">
                            <div class="service-list col-md-12 col-lg-12 col-sm-12 p-0">
                                <div class="service-item item-shadow">
                                    <img alt="" class="img-responsive"
                                        src="{{ asset('assets/layout/images/common/electrician.jpg') }}">
                                    <div class="blog-hover"></div>
                                </div>
                                <div class="service-section">
                                    <div class="service-content">
                        ...
                        <div class="item">
                            <div class="service-list col-md-12 col-lg-12 col-sm-12 p-0">
                                <div class="service-item item-shadow">
                                    <img alt="" class="img-responsive"
                                        src="{{ asset('assets/layout/images/common/laundry.jpg') }}">
                                    <div class="blog-hover"></div>
                                </div>
                                <div class="service-section">
                                    <div class="service-content">
                        ...
                        <div class="item">
                            <div class="service-list col-md-12 col-lg-12 col-sm-12 p-0">
                                <div class="service-item item-shadow">
                                    <img alt="" class="img-responsive"
                                        src="{{ asset('assets/layout/images/common/tutor.jpg') }}">
                                    <div class="blog-hover"></div>
                                </div>
                                <div class="service-section">
                                    <div class="service-content">
                        ...
                        <div class="item">
                            <div class="service-list col-md-12 col-lg-12 col-sm-12 p-0">
                                <div class="service-item item-shadow">
                                    <img alt="" class="img-responsive"
                                        src="{{ asset('assets/layout/images/common/cuddling.jpg') }}">
                                    <div class="blog-hover"></div>
                                </div>
                                <div class="service-section">
                                    <div class="service-content">
                        ...
                        <div class="item">
                            <div class="service-list col-md-12 col-lg-12 col-sm-12 p-0">
                                <div class="service-item item-shadow">
                                    <img alt="" class="img-responsive"
                                        src="{{ asset('assets/layout/images/common/dj.jpg') }}">
                                    <div class="blog-hover"></div>
                                </div>
                                <div class="service-section">
                                    <div class="service-content">
                        ...
                        <div class="item">
                            <div class="service-list col-md-12 col-lg-12 col-sm-12 p-0">
                                <div class="service-item item-shadow">
                                    <img alt="" class="img-responsive"
                                        src="{{ asset('assets/layout/images/common/lawn-mowing.jpg') }}">
                                    <div class="blog-hover"></div>
                                </div>
                                <div class="service-section">
                                    <div class="service-content">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-7">
                    <div class="app-info">
                        ...
                        <div class="app-links">
                            <a href="#"><img src="{{ asset('assets/layout/images/common/svg/app-store.png') }}"
                                    width="150" alt="" /></a>
                            <a href="#"><img src="{{ asset('assets/layout/images/common/svg/google-play.png') }}"
                                    width="150" alt="" /></a>
                        </div>
                    </div>
                </div>
    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            $('#rides').owlCarousel({
                ...
                navText: ['<span class="icon ion-ios-arrow-left"></span>',
