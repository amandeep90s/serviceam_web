    ...
    <div class="col-md-12">
        ...
        <div class="form_pad">
            <form class="validateForm" files="true">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="service_name" name="service_name"
                            placeholder="{{ __('service.admin.services.name') }}" value="">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                    <label for="customToggle2">Are you Professional ?</label>
                    <div class="custom-control custom-toggle">
                        <input type="checkbox" id="isProfessional" name="is_professional" class="custom-control-input"
                            value ='0'>
                        <label class="custom-control-label" for="isProfessional"></label>
                    </div>
                </div>
                <div class="form-group col-md-6">
                    <label for="customToggle2">Allow Description</label>
                    <div class="custom-control custom-toggle">
                        <input type="checkbox" id="allowDesc" name="allow_desc" class="custom-control-input"
                            value ='0'>
                        <label class="custom-control-label" for="allowDesc"></label>
                    </div>
                </div>
                <div class="form-group col-md-6">
                    <label for="customToggle2">Allow Before Image</label>
                    <div class="custom-control custom-toggle">
                        <input type="checkbox" id="allowBImage" name="allow_before_image" class="custom-control-input"
                            value ='0'>
                        <label class="custom-control-label" for="allowBImage"></label>
                    </div>
                </div>
                <div class="form-group col-md-6">
                    <label for="customToggle2">Allow After Image</label>
                    <div class="custom-control custom-toggle">
                        <input type="checkbox" id="allowAImage" name="allow_after_image" class="custom-control-input"
                            value ='0'>
        ...
        $('#service_category_id').on('change', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(data.responseData, function(key, item) {
                        $("#service_subcategory_id").append('<option value="' + item
                            .id + '">' + item.service_subcategory_name +
                            '</option>');
                    });
    ...
    function loadSubCategory() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#service_subcategory_id").append('<option>Select</option>');
                $.each(data.responseData, function(key, item) {
                    $("#service_subcategory_id").append('<option value="' + item.id + '">' + item
