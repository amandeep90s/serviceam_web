...
@section('title') Request History @stop
    ...
    <div class="main-content-container container-fluid px-4">
        <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                <span class="text-uppercase page-subtitle">Request History</span>
                <h3 class="page-title">Request History</h3>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card card-small">
                    <div class="card-header border-bottom">
                        <h6 class="m-0">Request History</h6>
                    </div>
                ...
                "columns": [{
...

                    {
                        ...
                        render: function(data, type, row) {
                            return row.user != null ? row.user.first_name + " " + row.user
                                .last_name : '';
                        }
                    },
                    {
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            if (row.payment != null) {
                                return row.currency + row.payment.total;
                            }
                            return 'N/A';
                        }
                    },
