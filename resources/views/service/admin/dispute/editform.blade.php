            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.responseData.dispute_type == "user") {
                        $("#dispute_user").val(data.responseData.user.first_name + " " + data
                            .responseData.user.last_name);
                    } else {
                        $("#dispute_user").val(data.responseData.provider.first_name + " " + data
                            .responseData.provider.last_name);
                    }
                    $("#dispute_type").val(data.responseData.dispute_type.charAt(0).toUpperCase() +
                        data.responseData.dispute_type.slice(1));
                    ...
                    $("#editstatus").val(data.responseData.status.charAt(0).toUpperCase() + data
