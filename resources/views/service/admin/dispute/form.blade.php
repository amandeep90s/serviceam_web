            ...
            $.ajax({
                ...
                success: function(data, textStatus, jqXHR) {
                    ...
                    if (data.data.length > 0) {
                        ...
                        for (var i in result) {
                            html += `<tr><td>` + result[i].booking_id + `</td><td>` + result[i]
                                .service.service_name +
                                `</td><td><input name="request_id" value="` + result[i].id +
                                `" type="radio" /><input name="user_id" value="` + result[i]
                                .user_id +
                                `" type="hidden" /><input name="provider_id" value="` + result[
                                    i].provider_id + `" type="hidden" /></td></tr>`;
                        }
