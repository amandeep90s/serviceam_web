        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input class="form-control" type="text" placeholder="MM/DD/YYYY" name="date"
                        onkeypress="return false">
                    <input class="form-control time-picker" type="text" placeholder="HH:MM" name="time"
                        onkeypress="return false">
                ...
                <form class="trip-frm2 w-100">
                    <div class="col-md-12 col-sm-12 col-lg-12 p-0 dis-reverse align-items-start">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6 form-section srchlist  ">
                            <div class="col-md-12 col-sm-12 col-lg-12 p-0">
                                <br />
                                <h5 class="text-left mb-3"> <b><a class=" provlist-back pull-left "> <i
    ...
    <script type="text/javascript">
        ...
        document.getElementById("allow_image").onchange = function(obj) {
            ...
            reader.onload = function(e) {
                ...
                if (obj.target.files[0].type == 'image/png' || obj.target.files[0].type == 'image/jpeg' || obj
            ...
            if (provider_result.length != 0) {
                ...
                $.each(provider_result, function(key, item) {
                    ...
                    html += `</div>
                        ...
                        `  class="btn btn-primary">Schedule Later <i class="fa fa-clock-o" aria-hidden="true"></i></a>
                                 <a id="request_service" class="btn  btn-primary ml-3"  data-target="#description" data-id =` +
                        item.id + `>Request a Service <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                              </div>
                           </div>
                        </li>`;
                });
