        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a id="schedule-later" class="btn btn-primary btn-block " data-toggle="modal"
                        data-target="#myModal">Schedule later</a>
                </div>
            </div>
        </div>
    </div>
    <div class="modal" id="descriptionModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a class="btn btn-primary btn-block" data-toggle="modal" data-target="#descriptionModal">Submit <i
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a id ="before_comment_details" class="btn btn-primary btn-block" data-toggle="modal"
                        data-target="#contactModal">Submit <i class="fa fa-check" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
    </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (result.length != 0) {
                            alert(1111);
                            html +=
                                `<ul id ="provider_list" class="provider-list invoice height50vh">`;
                            $.each(result, function(key, item) {
                                ...
                                html += `</div>
                                          <div class="actions col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                             <a id="schedule_service"  data-id =` + item.id +
                                    `  class="btn btn-green">Schedule Later <i class="fa fa-clock-o" aria-hidden="true"></i></a>
                                             <a id="request_service" class="btn  btn-green ml-3"  data-target="#description" data-id =` +
                                    item
                                    .id + `>Request a Service <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                                          </div>
                                       </div>
                                    </li>`;
                            });
