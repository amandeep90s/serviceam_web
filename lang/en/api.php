...
not be same as old password',
    ...
    'service' => [
        ...
        'already_onride' => 'Already Your order in process',
        'provider_rated' => 'Provider Rated',
        'request_scheduled' => 'Order Scheduled',
    ...
    'order' => [
        'request_inprogress' => 'Already Request in Progress',
        'no_providers_found' => 'No Drivers Found',
        'request_cancelled' => 'Your Order Cancelled',
        'already_cancelled' => 'Already Order Cancelled',
        'ride_cancelled' => 'Order Cancelled',
        'already_onride' => 'Already Your order in process',
        'provider_rated' => 'Provider Rated',
        'request_scheduled' => 'Order Scheduled',
        'request_already_scheduled' => 'Order Already Scheduled',
        'request_modify_location' => 'User Changed Destination Address',
        'request_completed' => 'Request Completed',
        'request_not_completed' => 'Request not yet completed',
        'request_rejected' => 'Request Rejected Successfully',
        'order_not_found' => 'Your Order Not found. Please try again.',
    ],
